import{d as j,c as R,o as T,r as C,n as ue,a as _e,t as Z,b as H,T as yi,w as L,e as B,_ as q,u as Gs,i as oh,f as ah,g as Ei,h as W,j as k,k as b,l as Lt,m as da,p as Ke,q as lh,s as Ti,v as uh,x as ne,y as ze,z as Ks,A as Ii,B as wi,C as Pl,D as Kn,E as Wn,F as fa,G as bt,H as le,I as Ve,J as U,K as Sl,L as Qe,M as pt,N as Ws,O as ch,P as Vl,Q as hh,R as Rl,S as kl,U as dh,V as Cl,W as Dl,X as fh,Y as ph,Z as mh,$ as gh,a0 as _h,a1 as pa,a2 as ma,a3 as vh}from"./framework.BLGVq54j.js";const yh=j({__name:"VPBadge",props:{text:{},type:{default:"tip"}},setup(s){return(e,t)=>(T(),R("span",{class:ue(["VPBadge",e.type])},[C(e.$slots,"default",{},()=>[_e(Z(e.text),1)])],2))}}),Eh={key:0,class:"VPBackdrop"},Th=j({__name:"VPBackdrop",props:{show:{type:Boolean}},setup(s){return(e,t)=>(T(),H(yi,{name:"fade"},{default:L(()=>[e.show?(T(),R("div",Eh)):B("",!0)]),_:1}))}}),Ih=q(Th,[["__scopeId","data-v-54a304ca"]]),se=Gs;function wh(s,e){let t,n=!1;return()=>{t&&clearTimeout(t),n?t=setTimeout(s,e):(s(),(n=!0)&&setTimeout(()=>n=!1,e))}}function Gr(s){return s.startsWith("/")?s:`/${s}`}function Ai(s){const{pathname:e,search:t,hash:n,protocol:r}=new URL(s,"http://a.com");if(oh(s)||s.startsWith("#")||!r.startsWith("http")||!ah(e))return s;const{site:o}=se(),a=e.endsWith("/")||e.endsWith(".html")?s:s.replace(/(?:(^\.+)\/)?.*$/,`$1${e.replace(/(\.md)?$/,o.value.cleanUrls?"":".html")}${t}${n}`);return Ei(a)}function Qn({correspondingLink:s=!1}={}){const{site:e,localeIndex:t,page:n,theme:r,hash:o}=se(),a=W(()=>{var h,d;return{label:(h=e.value.locales[t.value])==null?void 0:h.label,link:((d=e.value.locales[t.value])==null?void 0:d.link)||(t.value==="root"?"/":`/${t.value}/`)}});return{localeLinks:W(()=>Object.entries(e.value.locales).flatMap(([h,d])=>a.value.label===d.label?[]:{text:d.label,link:Ah(d.link||(h==="root"?"/":`/${h}/`),r.value.i18nRouting!==!1&&s,n.value.relativePath.slice(a.value.link.length-1),!e.value.cleanUrls)+o.value})),currentLang:a}}function Ah(s,e,t,n){return e?s.replace(/\/$/,"")+Gr(t.replace(/(^|\/)index\.md$/,"$1").replace(/\.md$/,n?".html":"")):s}const bh={class:"NotFound"},Ph={class:"code"},Sh={class:"title"},Vh={class:"quote"},Rh={class:"action"},kh=["href","aria-label"],Ch=j({__name:"NotFound",setup(s){const{theme:e}=se(),{currentLang:t}=Qn();return(n,r)=>{var o,a,u,h,d,p;return T(),R("div",bh,[k("p",Ph,Z(((o=b(e).notFound)==null?void 0:o.code)??"404"),1),k("h1",Sh,Z(((a=b(e).notFound)==null?void 0:a.title)??"PAGE NOT FOUND"),1),r[0]||(r[0]=k("div",{class:"divider"},null,-1)),k("blockquote",Vh,Z(((u=b(e).notFound)==null?void 0:u.quote)??"But if you don't change your direction, and if you keep looking, you may end up where you are heading."),1),k("div",Rh,[k("a",{class:"link",href:b(Ei)(((h=b(e).notFound)==null?void 0:h.link)??b(t).link),"aria-label":((d=b(e).notFound)==null?void 0:d.linkLabel)??"go to home"},Z(((p=b(e).notFound)==null?void 0:p.linkText)??"Take me home"),9,kh)])])}}}),Dh=q(Ch,[["__scopeId","data-v-b0126292"]]);function Nl(s,e){if(Array.isArray(s))return As(s);if(s==null)return[];e=Gr(e);const t=Object.keys(s).sort((r,o)=>o.split("/").length-r.split("/").length).find(r=>e.startsWith(Gr(r))),n=t?s[t]:[];return Array.isArray(n)?As(n):As(n.items,n.base)}function Nh(s){const e=[];let t=0;for(const n in s){const r=s[n];if(r.items){t=e.push(r);continue}e[t]||e.push({items:[]}),e[t].items.push(r)}return e}function Lh(s){const e=[];function t(n){for(const r of n)r.text&&r.link&&e.push({text:r.text,link:r.link,docFooterText:r.docFooterText}),r.items&&t(r.items)}return t(s),e}function Kr(s,e){return Array.isArray(e)?e.some(t=>Kr(s,t)):Lt(s,e.link)?!0:e.items?Kr(s,e.items):!1}function As(s,e){return[...s].map(t=>{const n={...t},r=n.base||e;return r&&n.link&&(n.link=r+n.link),n.items&&(n.items=As(n.items,r)),n})}function Mh(){const{hasSidebar:s}=lt(),e=da("(min-width: 960px)"),t=da("(min-width: 1280px)");return{isAsideEnabled:W(()=>!t.value&&!e.value?!1:s.value?t.value:e.value)}}const Oh=/\b(?:VPBadge|header-anchor|footnote-ref|ignore-header)\b/,Wr=[];function Ll(s){return typeof s.outline=="object"&&!Array.isArray(s.outline)&&s.outline.label||s.outlineTitle||"On this page"}function $h(s){const e=[...document.querySelectorAll(".VPDoc :where(h1,h2,h3,h4,h5,h6)")].filter(t=>t.id&&t.hasChildNodes()).map(t=>{const n=Number(t.tagName[1]);return{element:t,title:xh(t),link:"#"+t.id,level:n}});return Fh(e,s)}function xh(s){let e="";for(const t of s.childNodes)if(t.nodeType===1){if(Oh.test(t.className))continue;e+=t.textContent}else t.nodeType===3&&(e+=t.textContent);return e.trim()}function Fh(s,e){if(e===!1)return[];const t=(typeof e=="object"&&!Array.isArray(e)?e.level:e)||2,[n,r]=typeof t=="number"?[t,t]:t==="deep"?[2,6]:t;return jh(s,n,r)}function Bh(s,e){const{isAsideEnabled:t}=Mh(),n=wh(o,100);let r=null;Ke(()=>{requestAnimationFrame(o),window.addEventListener("scroll",n)}),lh(()=>{a(location.hash)}),Ti(()=>{window.removeEventListener("scroll",n)});function o(){if(!t.value)return;const u=window.scrollY,h=window.innerHeight,d=document.body.offsetHeight,p=Math.abs(u+h-d)<1,_=Wr.map(({element:S,link:M})=>({link:M,top:Uh(S)})).filter(({top:S})=>!Number.isNaN(S)).sort((S,M)=>S.top-M.top);if(!_.length){a(null);return}if(u<1){a(null);return}if(p){a(_[_.length-1].link);return}let y=null;for(const{link:S,top:M}of _){if(M>u+uh()+4)break;y=S}a(y)}function a(u){r&&r.classList.remove("active"),u==null?r=null:r=s.value.querySelector(`a[href="${decodeURIComponent(u)}"]`);const h=r;h?(h.classList.add("active"),e.value.style.top=h.offsetTop+39+"px",e.value.style.opacity="1"):(e.value.style.top="33px",e.value.style.opacity="0")}}function Uh(s){let e=0;for(;s!==document.body;){if(s===null)return NaN;e+=s.offsetTop,s=s.offsetParent}return e}function jh(s,e,t){Wr.length=0;const n=[],r=[];return s.forEach(o=>{const a={...o,children:[]};let u=r[r.length-1];for(;u&&u.level>=a.level;)r.pop(),u=r[r.length-1];if(a.element.classList.contains("ignore-header")||u&&"shouldIgnore"in u){r.push({level:a.level,shouldIgnore:!0});return}a.level>t||a.level<e||(Wr.push({element:a.element,link:a.link}),u?u.children.push(a):n.push(a),r.push(a))}),n}const Qt=ne(!1);function Hh(s){let e;Ks(()=>{e=Qt.value?document.activeElement:void 0}),Ke(()=>{window.addEventListener("keyup",t)}),Ti(()=>{window.removeEventListener("keyup",t)});function t(n){n.key==="Escape"&&Qt.value&&(s(),e==null||e.focus())}}function qh(){function s(){Qt.value=!0}function e(){Qt.value=!1}function t(){Qt.value?e():s()}return{isOpen:Qt,open:s,close:e,toggle:t}}function zh(s){const{page:e,hash:t}=se(),n=ne(!1),r=W(()=>s.value.collapsed!=null),o=W(()=>!!s.value.link),a=ne(!1),u=()=>{a.value=Lt(e.value.relativePath,s.value.link)};ze([e,s,t],u),Ke(u);const h=W(()=>a.value?!0:s.value.items?Kr(e.value.relativePath,s.value.items):!1),d=W(()=>!!(s.value.items&&s.value.items.length));Ks(()=>{n.value=!!(r.value&&s.value.collapsed)}),Ii(()=>{(a.value||h.value)&&(n.value=!1)});function p(){r.value&&(n.value=!n.value)}return{collapsed:n,collapsible:r,isLink:o,isActiveLink:a,hasActiveLink:h,hasChildren:d,toggle:p}}const Qr=wi([]),Cn=wi([]),Xr=wi(!1);function lt(){const{frontmatter:s,theme:e}=se(),t=W(()=>!!(s.value.isHome??s.value.layout==="home")),n=W(()=>s.value.sidebar!==!1&&Cn.value.length>0&&!t.value),r=W(()=>n.value&&Xr.value),o=W(()=>n.value?Nh(Cn.value):[]),a=W(()=>t.value?!1:s.value.aside!=null?!!s.value.aside:e.value.aside!==!1),u=W(()=>a.value?s.value.aside==null?e.value.aside==="left":s.value.aside==="left":!1),h=W(()=>Qr.value.length>0);return{isHome:t,sidebar:fa(Cn),sidebarGroups:o,hasSidebar:n,isSidebarEnabled:r,hasAside:a,leftAside:u,headers:fa(Qr),hasLocalNav:h}}function Gh({closeSidebar:s}){const{frontmatter:e,page:t,theme:n}=se();ze(()=>[t.value.relativePath,n.value.sidebar],([o,a])=>{const u=a?Nl(a,o):[];JSON.stringify(u)!==JSON.stringify(Cn.value)&&(Cn.value=u)},{immediate:!0,deep:!0,flush:"sync"}),Pl(()=>{Qr.value=$h(e.value.outline??n.value.outline)}),Kn&&(Xr.value=window.innerWidth>=960,window.addEventListener("resize",()=>{Xr.value=window.innerWidth>=960},{passive:!0}));const r=Wn();ze(()=>r.path,s),Hh(s)}const Kh=["href","title"],Wh=j({__name:"VPDocOutlineItem",props:{headers:{},root:{type:Boolean}},setup(s){function e({target:t}){const n=t.href.split("#")[1],r=document.getElementById(decodeURIComponent(n));r==null||r.focus({preventScroll:!0})}return(t,n)=>{const r=bt("VPDocOutlineItem",!0);return T(),R("ul",{class:ue(["VPDocOutlineItem",t.root?"root":"nested"])},[(T(!0),R(le,null,Ve(t.headers,({children:o,link:a,title:u})=>(T(),R("li",null,[k("a",{class:"outline-link",href:a,onClick:e,title:u},Z(u),9,Kh),o!=null&&o.length?(T(),H(r,{key:0,headers:o},null,8,["headers"])):B("",!0)]))),256))],2)}}}),Ml=q(Wh,[["__scopeId","data-v-b7d7ef80"]]),Qh={class:"content"},Xh={"aria-level":"2",class:"outline-title",id:"doc-outline-aria-label",role:"heading"},Yh=j({__name:"VPDocAsideOutline",setup(s){const{theme:e}=se(),t=ne(),n=ne(),{headers:r,hasLocalNav:o}=lt();return Bh(t,n),(a,u)=>(T(),R("nav",{"aria-labelledby":"doc-outline-aria-label",class:ue(["VPDocAsideOutline",{"has-outline":b(o)}]),ref_key:"container",ref:t},[k("div",Qh,[k("div",{class:"outline-marker",ref_key:"marker",ref:n},null,512),k("div",Xh,Z(b(Ll)(b(e))),1),U(Ml,{headers:b(r),root:!0},null,8,["headers"])])],2))}}),Jh=q(Yh,[["__scopeId","data-v-c8b19031"]]),Zh={class:"VPDocAsideCarbonAds"},ed=j({__name:"VPDocAsideCarbonAds",props:{carbonAds:{}},setup(s){const e=()=>null;return(t,n)=>(T(),R("div",Zh,[U(b(e),{"carbon-ads":t.carbonAds},null,8,["carbon-ads"])]))}}),td={class:"VPDocAside"},nd=j({__name:"VPDocAside",setup(s){const{theme:e}=se();return(t,n)=>(T(),R("div",td,[C(t.$slots,"aside-top",{},void 0,!0),C(t.$slots,"aside-outline-before",{},void 0,!0),U(Jh),C(t.$slots,"aside-outline-after",{},void 0,!0),n[0]||(n[0]=k("div",{class:"spacer"},null,-1)),C(t.$slots,"aside-ads-before",{},void 0,!0),b(e).carbonAds?(T(),H(ed,{key:0,"carbon-ads":b(e).carbonAds},null,8,["carbon-ads"])):B("",!0),C(t.$slots,"aside-ads-after",{},void 0,!0),C(t.$slots,"aside-bottom",{},void 0,!0)]))}}),sd=q(nd,[["__scopeId","data-v-cb998dce"]]);function rd(){const{theme:s,page:e}=se();return W(()=>{const{text:t="Edit this page",pattern:n=""}=s.value.editLink||{};let r;return typeof n=="function"?r=n(e.value):r=n.replace(/:path/g,e.value.filePath),{url:r,text:t}})}function id(){const{page:s,theme:e,frontmatter:t}=se();return W(()=>{var d,p,_,y,S,M,x,N;const n=Nl(e.value.sidebar,s.value.relativePath),r=Lh(n),o=od(r,X=>X.link.replace(/[?#].*$/,"")),a=o.findIndex(X=>Lt(s.value.relativePath,X.link)),u=((d=e.value.docFooter)==null?void 0:d.prev)===!1&&!t.value.prev||t.value.prev===!1,h=((p=e.value.docFooter)==null?void 0:p.next)===!1&&!t.value.next||t.value.next===!1;return{prev:u?void 0:{text:(typeof t.value.prev=="string"?t.value.prev:typeof t.value.prev=="object"?t.value.prev.text:void 0)??((_=o[a-1])==null?void 0:_.docFooterText)??((y=o[a-1])==null?void 0:y.text),link:(typeof t.value.prev=="object"?t.value.prev.link:void 0)??((S=o[a-1])==null?void 0:S.link)},next:h?void 0:{text:(typeof t.value.next=="string"?t.value.next:typeof t.value.next=="object"?t.value.next.text:void 0)??((M=o[a+1])==null?void 0:M.docFooterText)??((x=o[a+1])==null?void 0:x.text),link:(typeof t.value.next=="object"?t.value.next.link:void 0)??((N=o[a+1])==null?void 0:N.link)}}})}function od(s,e){const t=new Set;return s.filter(n=>{const r=e(n);return t.has(r)?!1:t.add(r)})}const Xe=j({__name:"VPLink",props:{tag:{},href:{},noIcon:{type:Boolean},target:{},rel:{}},setup(s){const e=s,t=W(()=>e.tag??(e.href?"a":"span")),n=W(()=>e.href&&Sl.test(e.href)||e.target==="_blank");return(r,o)=>(T(),H(Qe(t.value),{class:ue(["VPLink",{link:r.href,"vp-external-link-icon":n.value,"no-icon":r.noIcon}]),href:r.href?b(Ai)(r.href):void 0,target:r.target??(n.value?"_blank":void 0),rel:r.rel??(n.value?"noreferrer":void 0)},{default:L(()=>[C(r.$slots,"default")]),_:3},8,["class","href","target","rel"]))}}),ad={class:"VPLastUpdated"},ld=["datetime"],ud=j({__name:"VPDocFooterLastUpdated",setup(s){const{theme:e,page:t,lang:n}=se(),r=W(()=>new Date(t.value.lastUpdated)),o=W(()=>r.value.toISOString()),a=ne("");return Ke(()=>{Ks(()=>{var u,h,d;a.value=new Intl.DateTimeFormat((h=(u=e.value.lastUpdated)==null?void 0:u.formatOptions)!=null&&h.forceLocale?n.value:void 0,((d=e.value.lastUpdated)==null?void 0:d.formatOptions)??{dateStyle:"short",timeStyle:"short"}).format(r.value)})}),(u,h)=>{var d;return T(),R("p",ad,[_e(Z(((d=b(e).lastUpdated)==null?void 0:d.text)||b(e).lastUpdatedText||"Last updated")+": ",1),k("time",{datetime:o.value},Z(a.value),9,ld)])}}}),cd=q(ud,[["__scopeId","data-v-1bb0c8a8"]]),hd={key:0,class:"VPDocFooter"},dd={key:0,class:"edit-info"},fd={key:0,class:"edit-link"},pd={key:1,class:"last-updated"},md={key:1,class:"prev-next","aria-labelledby":"doc-footer-aria-label"},gd={class:"pager"},_d=["innerHTML"],vd=["innerHTML"],yd={class:"pager"},Ed=["innerHTML"],Td=["innerHTML"],Id=j({__name:"VPDocFooter",setup(s){const{theme:e,page:t,frontmatter:n}=se(),r=rd(),o=id(),a=W(()=>e.value.editLink&&n.value.editLink!==!1),u=W(()=>t.value.lastUpdated),h=W(()=>a.value||u.value||o.value.prev||o.value.next);return(d,p)=>{var _,y,S,M;return h.value?(T(),R("footer",hd,[C(d.$slots,"doc-footer-before",{},void 0,!0),a.value||u.value?(T(),R("div",dd,[a.value?(T(),R("div",fd,[U(Xe,{class:"edit-link-button",href:b(r).url,"no-icon":!0},{default:L(()=>[p[0]||(p[0]=k("span",{class:"vpi-square-pen edit-link-icon"},null,-1)),_e(" "+Z(b(r).text),1)]),_:1,__:[0]},8,["href"])])):B("",!0),u.value?(T(),R("div",pd,[U(cd)])):B("",!0)])):B("",!0),(_=b(o).prev)!=null&&_.link||(y=b(o).next)!=null&&y.link?(T(),R("nav",md,[p[1]||(p[1]=k("span",{class:"visually-hidden",id:"doc-footer-aria-label"},"Pager",-1)),k("div",gd,[(S=b(o).prev)!=null&&S.link?(T(),H(Xe,{key:0,class:"pager-link prev",href:b(o).prev.link},{default:L(()=>{var x;return[k("span",{class:"desc",innerHTML:((x=b(e).docFooter)==null?void 0:x.prev)||"Previous page"},null,8,_d),k("span",{class:"title",innerHTML:b(o).prev.text},null,8,vd)]}),_:1},8,["href"])):B("",!0)]),k("div",yd,[(M=b(o).next)!=null&&M.link?(T(),H(Xe,{key:0,class:"pager-link next",href:b(o).next.link},{default:L(()=>{var x;return[k("span",{class:"desc",innerHTML:((x=b(e).docFooter)==null?void 0:x.next)||"Next page"},null,8,Ed),k("span",{class:"title",innerHTML:b(o).next.text},null,8,Td)]}),_:1},8,["href"])):B("",!0)])])):B("",!0)])):B("",!0)}}}),wd=q(Id,[["__scopeId","data-v-1bcd8184"]]),Ad={class:"container"},bd={class:"aside-container"},Pd={class:"aside-content"},Sd={class:"content"},Vd={class:"content-container"},Rd={class:"main"},kd=j({__name:"VPDoc",setup(s){const{theme:e}=se(),t=Wn(),{hasSidebar:n,hasAside:r,leftAside:o}=lt(),a=W(()=>t.path.replace(/[./]+/g,"_").replace(/_html$/,""));return(u,h)=>{const d=bt("Content");return T(),R("div",{class:ue(["VPDoc",{"has-sidebar":b(n),"has-aside":b(r)}])},[C(u.$slots,"doc-top",{},void 0,!0),k("div",Ad,[b(r)?(T(),R("div",{key:0,class:ue(["aside",{"left-aside":b(o)}])},[h[0]||(h[0]=k("div",{class:"aside-curtain"},null,-1)),k("div",bd,[k("div",Pd,[U(sd,null,{"aside-top":L(()=>[C(u.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":L(()=>[C(u.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":L(()=>[C(u.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":L(()=>[C(u.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":L(()=>[C(u.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":L(()=>[C(u.$slots,"aside-ads-after",{},void 0,!0)]),_:3})])])],2)):B("",!0),k("div",Sd,[k("div",Vd,[C(u.$slots,"doc-before",{},void 0,!0),k("main",Rd,[U(d,{class:ue(["vp-doc",[a.value,b(e).externalLinkIcon&&"external-link-icon-enabled"]])},null,8,["class"])]),U(wd,null,{"doc-footer-before":L(()=>[C(u.$slots,"doc-footer-before",{},void 0,!0)]),_:3}),C(u.$slots,"doc-after",{},void 0,!0)])])]),C(u.$slots,"doc-bottom",{},void 0,!0)],2)}}}),Cd=q(kd,[["__scopeId","data-v-d668f7cc"]]),Dd=j({__name:"VPButton",props:{tag:{},size:{default:"medium"},theme:{default:"brand"},text:{},href:{},target:{},rel:{}},setup(s){const e=s,t=W(()=>e.href&&Sl.test(e.href)),n=W(()=>e.tag||(e.href?"a":"button"));return(r,o)=>(T(),H(Qe(n.value),{class:ue(["VPButton",[r.size,r.theme]]),href:r.href?b(Ai)(r.href):void 0,target:e.target??(t.value?"_blank":void 0),rel:e.rel??(t.value?"noreferrer":void 0)},{default:L(()=>[C(r.$slots,"default",{},()=>[_e(Z(r.text),1)],!0)]),_:3},8,["class","href","target","rel"]))}}),Nd=q(Dd,[["__scopeId","data-v-58d3b43b"]]),Ld=["src","alt"],Md=j({inheritAttrs:!1,__name:"VPImage",props:{image:{},alt:{}},setup(s){return(e,t)=>{const n=bt("VPImage",!0);return e.image?(T(),R(le,{key:0},[typeof e.image=="string"||"src"in e.image?(T(),R("img",pt({key:0,class:"VPImage"},typeof e.image=="string"?e.$attrs:{...e.image,...e.$attrs},{src:b(Ei)(typeof e.image=="string"?e.image:e.image.src),alt:e.alt??(typeof e.image=="string"?"":e.image.alt||"")}),null,16,Ld)):(T(),R(le,{key:1},[U(n,pt({class:"dark",image:e.image.dark,alt:e.image.alt},e.$attrs),null,16,["image","alt"]),U(n,pt({class:"light",image:e.image.light,alt:e.image.alt},e.$attrs),null,16,["image","alt"])],64))],64)):B("",!0)}}}),ks=q(Md,[["__scopeId","data-v-ab19afbb"]]),Od={class:"container"},$d={class:"main"},xd={class:"heading"},Fd=["innerHTML"],Bd=["innerHTML"],Ud=["innerHTML"],jd={key:0,class:"actions"},Hd={key:0,class:"image"},qd={class:"image-container"},zd=j({__name:"VPHero",props:{name:{},text:{},tagline:{},image:{},actions:{}},setup(s){const e=Ws("hero-image-slot-exists");return(t,n)=>(T(),R("div",{class:ue(["VPHero",{"has-image":t.image||b(e)}])},[k("div",Od,[k("div",$d,[C(t.$slots,"home-hero-info-before",{},void 0,!0),C(t.$slots,"home-hero-info",{},()=>[k("h1",xd,[t.name?(T(),R("span",{key:0,innerHTML:t.name,class:"name clip"},null,8,Fd)):B("",!0),t.text?(T(),R("span",{key:1,innerHTML:t.text,class:"text"},null,8,Bd)):B("",!0)]),t.tagline?(T(),R("p",{key:0,innerHTML:t.tagline,class:"tagline"},null,8,Ud)):B("",!0)],!0),C(t.$slots,"home-hero-info-after",{},void 0,!0),t.actions?(T(),R("div",jd,[(T(!0),R(le,null,Ve(t.actions,r=>(T(),R("div",{key:r.link,class:"action"},[U(Nd,{tag:"a",size:"medium",theme:r.theme,text:r.text,href:r.link,target:r.target,rel:r.rel},null,8,["theme","text","href","target","rel"])]))),128))])):B("",!0),C(t.$slots,"home-hero-actions-after",{},void 0,!0)]),t.image||b(e)?(T(),R("div",Hd,[k("div",qd,[n[0]||(n[0]=k("div",{class:"image-bg"},null,-1)),C(t.$slots,"home-hero-image",{},()=>[t.image?(T(),H(ks,{key:0,class:"image-src",image:t.image},null,8,["image"])):B("",!0)],!0)])])):B("",!0)])],2))}}),Gd=q(zd,[["__scopeId","data-v-8a17128e"]]),Kd=j({__name:"VPHomeHero",setup(s){const{frontmatter:e}=se();return(t,n)=>b(e).hero?(T(),H(Gd,{key:0,class:"VPHomeHero",name:b(e).hero.name,text:b(e).hero.text,tagline:b(e).hero.tagline,image:b(e).hero.image,actions:b(e).hero.actions},{"home-hero-info-before":L(()=>[C(t.$slots,"home-hero-info-before")]),"home-hero-info":L(()=>[C(t.$slots,"home-hero-info")]),"home-hero-info-after":L(()=>[C(t.$slots,"home-hero-info-after")]),"home-hero-actions-after":L(()=>[C(t.$slots,"home-hero-actions-after")]),"home-hero-image":L(()=>[C(t.$slots,"home-hero-image")]),_:3},8,["name","text","tagline","image","actions"])):B("",!0)}}),Wd={class:"box"},Qd={key:0,class:"icon"},Xd=["innerHTML"],Yd=["innerHTML"],Jd=["innerHTML"],Zd={key:4,class:"link-text"},ef={class:"link-text-value"},tf=j({__name:"VPFeature",props:{icon:{},title:{},details:{},link:{},linkText:{},rel:{},target:{}},setup(s){return(e,t)=>(T(),H(Xe,{class:"VPFeature",href:e.link,rel:e.rel,target:e.target,"no-icon":!0,tag:e.link?"a":"div"},{default:L(()=>[k("article",Wd,[typeof e.icon=="object"&&e.icon.wrap?(T(),R("div",Qd,[U(ks,{image:e.icon,alt:e.icon.alt,height:e.icon.height||48,width:e.icon.width||48},null,8,["image","alt","height","width"])])):typeof e.icon=="object"?(T(),H(ks,{key:1,image:e.icon,alt:e.icon.alt,height:e.icon.height||48,width:e.icon.width||48},null,8,["image","alt","height","width"])):e.icon?(T(),R("div",{key:2,class:"icon",innerHTML:e.icon},null,8,Xd)):B("",!0),k("h2",{class:"title",innerHTML:e.title},null,8,Yd),e.details?(T(),R("p",{key:3,class:"details",innerHTML:e.details},null,8,Jd)):B("",!0),e.linkText?(T(),R("div",Zd,[k("p",ef,[_e(Z(e.linkText)+" ",1),t[0]||(t[0]=k("span",{class:"vpi-arrow-right link-text-icon"},null,-1))])])):B("",!0)])]),_:1},8,["href","rel","target","tag"]))}}),nf=q(tf,[["__scopeId","data-v-02d1074d"]]),sf={key:0,class:"VPFeatures"},rf={class:"container"},of={class:"items"},af=j({__name:"VPFeatures",props:{features:{}},setup(s){const e=s,t=W(()=>{const n=e.features.length;if(n){if(n===2)return"grid-2";if(n===3)return"grid-3";if(n%3===0)return"grid-6";if(n>3)return"grid-4"}else return});return(n,r)=>n.features?(T(),R("div",sf,[k("div",rf,[k("div",of,[(T(!0),R(le,null,Ve(n.features,o=>(T(),R("div",{key:o.title,class:ue(["item",[t.value]])},[U(nf,{icon:o.icon,title:o.title,details:o.details,link:o.link,"link-text":o.linkText,rel:o.rel,target:o.target},null,8,["icon","title","details","link","link-text","rel","target"])],2))),128))])])])):B("",!0)}}),lf=q(af,[["__scopeId","data-v-b1eea84a"]]),uf=j({__name:"VPHomeFeatures",setup(s){const{frontmatter:e}=se();return(t,n)=>b(e).features?(T(),H(lf,{key:0,class:"VPHomeFeatures",features:b(e).features},null,8,["features"])):B("",!0)}}),cf=j({__name:"VPHomeContent",setup(s){const{width:e}=ch({initialWidth:0,includeScrollbar:!1});return(t,n)=>(T(),R("div",{class:"vp-doc container",style:Vl(b(e)?{"--vp-offset":`calc(50% - ${b(e)/2}px)`}:{})},[C(t.$slots,"default",{},void 0,!0)],4))}}),hf=q(cf,[["__scopeId","data-v-c141a4bd"]]),df=j({__name:"VPHome",setup(s){const{frontmatter:e,theme:t}=se();return(n,r)=>{const o=bt("Content");return T(),R("div",{class:ue(["VPHome",{"external-link-icon-enabled":b(t).externalLinkIcon}])},[C(n.$slots,"home-hero-before",{},void 0,!0),U(Kd,null,{"home-hero-info-before":L(()=>[C(n.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":L(()=>[C(n.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":L(()=>[C(n.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":L(()=>[C(n.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":L(()=>[C(n.$slots,"home-hero-image",{},void 0,!0)]),_:3}),C(n.$slots,"home-hero-after",{},void 0,!0),C(n.$slots,"home-features-before",{},void 0,!0),U(uf),C(n.$slots,"home-features-after",{},void 0,!0),b(e).markdownStyles!==!1?(T(),H(hf,{key:0},{default:L(()=>[U(o)]),_:1})):(T(),H(o,{key:1}))],2)}}}),ff=q(df,[["__scopeId","data-v-e07eaea7"]]),pf={},mf={class:"VPPage"};function gf(s,e){const t=bt("Content");return T(),R("div",mf,[C(s.$slots,"page-top"),U(t),C(s.$slots,"page-bottom")])}const _f=q(pf,[["render",gf]]),vf=j({__name:"VPContent",setup(s){const{page:e,frontmatter:t}=se(),{isHome:n,hasSidebar:r}=lt();return(o,a)=>(T(),R("div",{class:ue(["VPContent",{"has-sidebar":b(r),"is-home":b(n)}]),id:"VPContent"},[b(e).isNotFound?C(o.$slots,"not-found",{key:0},()=>[U(Dh)],!0):b(t).layout==="page"?(T(),H(_f,{key:1},{"page-top":L(()=>[C(o.$slots,"page-top",{},void 0,!0)]),"page-bottom":L(()=>[C(o.$slots,"page-bottom",{},void 0,!0)]),_:3})):b(t).layout==="home"?(T(),H(ff,{key:2},{"home-hero-before":L(()=>[C(o.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":L(()=>[C(o.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":L(()=>[C(o.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":L(()=>[C(o.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":L(()=>[C(o.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":L(()=>[C(o.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":L(()=>[C(o.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":L(()=>[C(o.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":L(()=>[C(o.$slots,"home-features-after",{},void 0,!0)]),_:3})):b(t).layout&&b(t).layout!=="doc"?(T(),H(Qe(b(t).layout),{key:3})):(T(),H(Cd,{key:4},{"doc-top":L(()=>[C(o.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":L(()=>[C(o.$slots,"doc-bottom",{},void 0,!0)]),"doc-footer-before":L(()=>[C(o.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":L(()=>[C(o.$slots,"doc-before",{},void 0,!0)]),"doc-after":L(()=>[C(o.$slots,"doc-after",{},void 0,!0)]),"aside-top":L(()=>[C(o.$slots,"aside-top",{},void 0,!0)]),"aside-outline-before":L(()=>[C(o.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":L(()=>[C(o.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":L(()=>[C(o.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":L(()=>[C(o.$slots,"aside-ads-after",{},void 0,!0)]),"aside-bottom":L(()=>[C(o.$slots,"aside-bottom",{},void 0,!0)]),_:3}))],2))}}),yf=q(vf,[["__scopeId","data-v-2652e39a"]]),Ef={class:"container"},Tf=["innerHTML"],If=["innerHTML"],wf=j({__name:"VPFooter",setup(s){const{theme:e,frontmatter:t}=se(),{hasSidebar:n}=lt();return(r,o)=>b(e).footer&&b(t).footer!==!1?(T(),R("footer",{key:0,class:ue(["VPFooter",{"has-sidebar":b(n)}])},[k("div",Ef,[b(e).footer.message?(T(),R("p",{key:0,class:"message",innerHTML:b(e).footer.message},null,8,Tf)):B("",!0),b(e).footer.copyright?(T(),R("p",{key:1,class:"copyright",innerHTML:b(e).footer.copyright},null,8,If)):B("",!0)])],2)):B("",!0)}}),Af=q(wf,[["__scopeId","data-v-5b9946f5"]]),bf={class:"menu-text"},Pf={class:"header"},Sf={class:"outline"},Vf=j({__name:"VPLocalNavOutlineDropdown",props:{headers:{},navHeight:{}},setup(s){const e=s,{theme:t}=se(),n=ne(!1),r=ne(0),o=ne(),a=ne();function u(_){var y;(y=o.value)!=null&&y.contains(_.target)||(n.value=!1)}ze(n,_=>{if(_){document.addEventListener("click",u);return}document.removeEventListener("click",u)}),hh("Escape",()=>{n.value=!1}),Pl(()=>{n.value=!1});function h(){n.value=!n.value,r.value=window.innerHeight+Math.min(window.scrollY-e.navHeight,0)}function d(_){_.target.classList.contains("outline-link")&&(a.value&&(a.value.style.transition="none"),Rl(()=>{n.value=!1}))}function p(){n.value=!1,window.scrollTo({top:0,left:0,behavior:"smooth"})}return(_,y)=>(T(),R("div",{class:"VPLocalNavOutlineDropdown",style:Vl({"--vp-vh":r.value+"px"}),ref_key:"main",ref:o},[_.headers.length>0?(T(),R("button",{key:0,onClick:h,class:ue({open:n.value})},[k("span",bf,Z(b(Ll)(b(t))),1),y[0]||(y[0]=k("span",{class:"vpi-chevron-right icon"},null,-1))],2)):(T(),R("button",{key:1,onClick:p},Z(b(t).returnToTopLabel||"Return to top"),1)),U(yi,{name:"flyout"},{default:L(()=>[n.value?(T(),R("div",{key:0,ref_key:"items",ref:a,class:"items",onClick:d},[k("div",Pf,[k("a",{class:"top-link",href:"#",onClick:p},Z(b(t).returnToTopLabel||"Return to top"),1)]),k("div",Sf,[U(Ml,{headers:_.headers},null,8,["headers"])])],512)):B("",!0)]),_:1})],4))}}),Rf=q(Vf,[["__scopeId","data-v-92b7576c"]]),kf={class:"container"},Cf=["aria-expanded"],Df={class:"menu-text"},Nf=j({__name:"VPLocalNav",props:{open:{type:Boolean}},emits:["open-menu"],setup(s){const{theme:e}=se(),{isHome:t,hasSidebar:n,headers:r,hasLocalNav:o}=lt(),{y:a}=kl(),u=ne(0);Ke(()=>{u.value=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--vp-nav-height"))});const h=W(()=>({VPLocalNav:!0,"has-sidebar":n.value,empty:!o.value,fixed:!o.value&&!n.value}));return(d,p)=>!b(t)&&(b(o)||b(n)||b(a)>=u.value)?(T(),R("div",{key:0,class:ue(h.value)},[k("div",kf,[b(n)?(T(),R("button",{key:0,class:"menu","aria-expanded":d.open,"aria-controls":"VPSidebarNav",onClick:p[0]||(p[0]=_=>d.$emit("open-menu"))},[p[1]||(p[1]=k("span",{class:"vpi-align-left menu-icon"},null,-1)),k("span",Df,Z(b(e).sidebarMenuLabel||"Menu"),1)],8,Cf)):B("",!0),U(Rf,{headers:b(r),navHeight:u.value},null,8,["headers","navHeight"])])],2)):B("",!0)}}),Lf=q(Nf,[["__scopeId","data-v-6c0451ca"]]);function Mf(){const s=ne(!1);function e(){s.value=!0,window.addEventListener("resize",r)}function t(){s.value=!1,window.removeEventListener("resize",r)}function n(){s.value?t():e()}function r(){window.outerWidth>=768&&t()}const o=Wn();return ze(()=>o.path,t),{isScreenOpen:s,openScreen:e,closeScreen:t,toggleScreen:n}}const Of={},$f={class:"VPSwitch",type:"button",role:"switch"},xf={class:"check"},Ff={key:0,class:"icon"};function Bf(s,e){return T(),R("button",$f,[k("span",xf,[s.$slots.default?(T(),R("span",Ff,[C(s.$slots,"default",{},void 0,!0)])):B("",!0)])])}const Uf=q(Of,[["render",Bf],["__scopeId","data-v-b4ccac88"]]),jf=j({__name:"VPSwitchAppearance",setup(s){const{isDark:e,theme:t}=se(),n=Ws("toggle-appearance",()=>{e.value=!e.value}),r=ne("");return Ii(()=>{r.value=e.value?t.value.lightModeSwitchTitle||"Switch to light theme":t.value.darkModeSwitchTitle||"Switch to dark theme"}),(o,a)=>(T(),H(Uf,{title:r.value,class:"VPSwitchAppearance","aria-checked":b(e),onClick:b(n)},{default:L(()=>a[0]||(a[0]=[k("span",{class:"vpi-sun sun"},null,-1),k("span",{class:"vpi-moon moon"},null,-1)])),_:1,__:[0]},8,["title","aria-checked","onClick"]))}}),bi=q(jf,[["__scopeId","data-v-be9742d9"]]),Hf={key:0,class:"VPNavBarAppearance"},qf=j({__name:"VPNavBarAppearance",setup(s){const{site:e}=se();return(t,n)=>b(e).appearance&&b(e).appearance!=="force-dark"&&b(e).appearance!=="force-auto"?(T(),R("div",Hf,[U(bi)])):B("",!0)}}),zf=q(qf,[["__scopeId","data-v-3f90c1a5"]]),Pi=ne();let Ol=!1,$r=0;function Gf(s){const e=ne(!1);if(Kn){!Ol&&Kf(),$r++;const t=ze(Pi,n=>{var r,o,a;n===s.el.value||(r=s.el.value)!=null&&r.contains(n)?(e.value=!0,(o=s.onFocus)==null||o.call(s)):(e.value=!1,(a=s.onBlur)==null||a.call(s))});Ti(()=>{t(),$r--,$r||Wf()})}return dh(e)}function Kf(){document.addEventListener("focusin",$l),Ol=!0,Pi.value=document.activeElement}function Wf(){document.removeEventListener("focusin",$l)}function $l(){Pi.value=document.activeElement}const Qf={class:"VPMenuLink"},Xf=["innerHTML"],Yf=j({__name:"VPMenuLink",props:{item:{}},setup(s){const{page:e}=se();return(t,n)=>(T(),R("div",Qf,[U(Xe,{class:ue({active:b(Lt)(b(e).relativePath,t.item.activeMatch||t.item.link,!!t.item.activeMatch)}),href:t.item.link,target:t.item.target,rel:t.item.rel,"no-icon":t.item.noIcon},{default:L(()=>[k("span",{innerHTML:t.item.text},null,8,Xf)]),_:1},8,["class","href","target","rel","no-icon"])]))}}),Qs=q(Yf,[["__scopeId","data-v-7eeeb2dc"]]),Jf={class:"VPMenuGroup"},Zf={key:0,class:"title"},ep=j({__name:"VPMenuGroup",props:{text:{},items:{}},setup(s){return(e,t)=>(T(),R("div",Jf,[e.text?(T(),R("p",Zf,Z(e.text),1)):B("",!0),(T(!0),R(le,null,Ve(e.items,n=>(T(),R(le,null,["link"in n?(T(),H(Qs,{key:0,item:n},null,8,["item"])):B("",!0)],64))),256))]))}}),tp=q(ep,[["__scopeId","data-v-383108e6"]]),np={class:"VPMenu"},sp={key:0,class:"items"},rp=j({__name:"VPMenu",props:{items:{}},setup(s){return(e,t)=>(T(),R("div",np,[e.items?(T(),R("div",sp,[(T(!0),R(le,null,Ve(e.items,n=>(T(),R(le,{key:JSON.stringify(n)},["link"in n?(T(),H(Qs,{key:0,item:n},null,8,["item"])):"component"in n?(T(),H(Qe(n.component),pt({key:1,ref_for:!0},n.props),null,16)):(T(),H(tp,{key:2,text:n.text,items:n.items},null,8,["text","items"]))],64))),128))])):B("",!0),C(e.$slots,"default",{},void 0,!0)]))}}),ip=q(rp,[["__scopeId","data-v-2f78439e"]]),op=["aria-expanded","aria-label"],ap={key:0,class:"text"},lp=["innerHTML"],up={key:1,class:"vpi-more-horizontal icon"},cp={class:"menu"},hp=j({__name:"VPFlyout",props:{icon:{},button:{},label:{},items:{}},setup(s){const e=ne(!1),t=ne();Gf({el:t,onBlur:n});function n(){e.value=!1}return(r,o)=>(T(),R("div",{class:"VPFlyout",ref_key:"el",ref:t,onMouseenter:o[1]||(o[1]=a=>e.value=!0),onMouseleave:o[2]||(o[2]=a=>e.value=!1)},[k("button",{type:"button",class:"button","aria-haspopup":"true","aria-expanded":e.value,"aria-label":r.label,onClick:o[0]||(o[0]=a=>e.value=!e.value)},[r.button||r.icon?(T(),R("span",ap,[r.icon?(T(),R("span",{key:0,class:ue([r.icon,"option-icon"])},null,2)):B("",!0),r.button?(T(),R("span",{key:1,innerHTML:r.button},null,8,lp)):B("",!0),o[3]||(o[3]=k("span",{class:"vpi-chevron-down text-icon"},null,-1))])):(T(),R("span",up))],8,op),k("div",cp,[U(ip,{items:r.items},{default:L(()=>[C(r.$slots,"default",{},void 0,!0)]),_:3},8,["items"])])],544))}}),Si=q(hp,[["__scopeId","data-v-9bb987dd"]]),dp=["href","aria-label","innerHTML"],fp=j({__name:"VPSocialLink",props:{icon:{},link:{},ariaLabel:{}},setup(s){const e=s,t=ne();Ke(async()=>{var o;await Rl();const r=(o=t.value)==null?void 0:o.children[0];r instanceof HTMLElement&&r.className.startsWith("vpi-social-")&&(getComputedStyle(r).maskImage||getComputedStyle(r).webkitMaskImage)==="none"&&r.style.setProperty("--icon",`url('https://api.iconify.design/simple-icons/${e.icon}.svg')`)});const n=W(()=>typeof e.icon=="object"?e.icon.svg:`<span class="vpi-social-${e.icon}"></span>`);return(r,o)=>(T(),R("a",{ref_key:"el",ref:t,class:"VPSocialLink no-icon",href:r.link,"aria-label":r.ariaLabel??(typeof r.icon=="string"?r.icon:""),target:"_blank",rel:"noopener",innerHTML:n.value},null,8,dp))}}),pp=q(fp,[["__scopeId","data-v-60a9a2d3"]]),mp={class:"VPSocialLinks"},gp=j({__name:"VPSocialLinks",props:{links:{}},setup(s){return(e,t)=>(T(),R("div",mp,[(T(!0),R(le,null,Ve(e.links,({link:n,icon:r,ariaLabel:o})=>(T(),H(pp,{key:n,icon:r,link:n,ariaLabel:o},null,8,["icon","link","ariaLabel"]))),128))]))}}),Vi=q(gp,[["__scopeId","data-v-b51b99b1"]]),_p={key:0,class:"group translations"},vp={class:"trans-title"},yp={key:1,class:"group"},Ep={class:"item appearance"},Tp={class:"label"},Ip={class:"appearance-action"},wp={key:2,class:"group"},Ap={class:"item social-links"},bp=j({__name:"VPNavBarExtra",setup(s){const{site:e,theme:t}=se(),{localeLinks:n,currentLang:r}=Qn({correspondingLink:!0}),o=W(()=>n.value.length&&r.value.label||e.value.appearance||t.value.socialLinks);return(a,u)=>o.value?(T(),H(Si,{key:0,class:"VPNavBarExtra",label:"extra navigation"},{default:L(()=>[b(n).length&&b(r).label?(T(),R("div",_p,[k("p",vp,Z(b(r).label),1),(T(!0),R(le,null,Ve(b(n),h=>(T(),H(Qs,{key:h.link,item:h},null,8,["item"]))),128))])):B("",!0),b(e).appearance&&b(e).appearance!=="force-dark"&&b(e).appearance!=="force-auto"?(T(),R("div",yp,[k("div",Ep,[k("p",Tp,Z(b(t).darkModeSwitchLabel||"Appearance"),1),k("div",Ip,[U(bi)])])])):B("",!0),b(t).socialLinks?(T(),R("div",wp,[k("div",Ap,[U(Vi,{class:"social-links-list",links:b(t).socialLinks},null,8,["links"])])])):B("",!0)]),_:1})):B("",!0)}}),Pp=q(bp,[["__scopeId","data-v-f953d92f"]]),Sp=["aria-expanded"],Vp=j({__name:"VPNavBarHamburger",props:{active:{type:Boolean}},emits:["click"],setup(s){return(e,t)=>(T(),R("button",{type:"button",class:ue(["VPNavBarHamburger",{active:e.active}]),"aria-label":"mobile navigation","aria-expanded":e.active,"aria-controls":"VPNavScreen",onClick:t[0]||(t[0]=n=>e.$emit("click"))},t[1]||(t[1]=[k("span",{class:"container"},[k("span",{class:"top"}),k("span",{class:"middle"}),k("span",{class:"bottom"})],-1)]),10,Sp))}}),Rp=q(Vp,[["__scopeId","data-v-6bee1efd"]]),kp=["innerHTML"],Cp=j({__name:"VPNavBarMenuLink",props:{item:{}},setup(s){const{page:e}=se();return(t,n)=>(T(),H(Xe,{class:ue({VPNavBarMenuLink:!0,active:b(Lt)(b(e).relativePath,t.item.activeMatch||t.item.link,!!t.item.activeMatch)}),href:t.item.link,target:t.item.target,rel:t.item.rel,"no-icon":t.item.noIcon,tabindex:"0"},{default:L(()=>[k("span",{innerHTML:t.item.text},null,8,kp)]),_:1},8,["class","href","target","rel","no-icon"]))}}),Dp=q(Cp,[["__scopeId","data-v-815115f5"]]),Np=j({__name:"VPNavBarMenuGroup",props:{item:{}},setup(s){const e=s,{page:t}=se(),n=o=>"component"in o?!1:"link"in o?Lt(t.value.relativePath,o.link,!!e.item.activeMatch):o.items.some(n),r=W(()=>n(e.item));return(o,a)=>(T(),H(Si,{class:ue({VPNavBarMenuGroup:!0,active:b(Lt)(b(t).relativePath,o.item.activeMatch,!!o.item.activeMatch)||r.value}),button:o.item.text,items:o.item.items},null,8,["class","button","items"]))}}),Lp={key:0,"aria-labelledby":"main-nav-aria-label",class:"VPNavBarMenu"},Mp=j({__name:"VPNavBarMenu",setup(s){const{theme:e}=se();return(t,n)=>b(e).nav?(T(),R("nav",Lp,[n[0]||(n[0]=k("span",{id:"main-nav-aria-label",class:"visually-hidden"}," Main Navigation ",-1)),(T(!0),R(le,null,Ve(b(e).nav,r=>(T(),R(le,{key:JSON.stringify(r)},["link"in r?(T(),H(Dp,{key:0,item:r},null,8,["item"])):"component"in r?(T(),H(Qe(r.component),pt({key:1,ref_for:!0},r.props),null,16)):(T(),H(Np,{key:2,item:r},null,8,["item"]))],64))),128))])):B("",!0)}}),Op=q(Mp,[["__scopeId","data-v-020be4db"]]);function $p(s){const{localeIndex:e,theme:t}=se();function n(r){var M,x,N;const o=r.split("."),a=(M=t.value.search)==null?void 0:M.options,u=a&&typeof a=="object",h=u&&((N=(x=a.locales)==null?void 0:x[e.value])==null?void 0:N.translations)||null,d=u&&a.translations||null;let p=h,_=d,y=s;const S=o.pop();for(const X of o){let K=null;const ee=y==null?void 0:y[X];ee&&(K=y=ee);const he=_==null?void 0:_[X];he&&(K=_=he);const ke=p==null?void 0:p[X];ke&&(K=p=ke),ee||(y=K),he||(_=K),ke||(p=K)}return(p==null?void 0:p[S])??(_==null?void 0:_[S])??(y==null?void 0:y[S])??""}return n}const xp=["aria-label"],Fp={class:"DocSearch-Button-Container"},Bp={class:"DocSearch-Button-Placeholder"},ga=j({__name:"VPNavBarSearchButton",setup(s){const t=$p({button:{buttonText:"Search",buttonAriaLabel:"Search"}});return(n,r)=>(T(),R("button",{type:"button",class:"DocSearch DocSearch-Button","aria-label":b(t)("button.buttonAriaLabel")},[k("span",Fp,[r[0]||(r[0]=k("span",{class:"vp-icon DocSearch-Search-Icon"},null,-1)),k("span",Bp,Z(b(t)("button.buttonText")),1)]),r[1]||(r[1]=k("span",{class:"DocSearch-Button-Keys"},[k("kbd",{class:"DocSearch-Button-Key"}),k("kbd",{class:"DocSearch-Button-Key"},"K")],-1))],8,xp))}}),Up={class:"VPNavBarSearch"},jp={id:"local-search"},Hp={key:1,id:"docsearch"},qp=j({__name:"VPNavBarSearch",setup(s){const e=()=>null,t=()=>null,{theme:n}=se(),r=ne(!1),o=ne(!1);Ke(()=>{});function a(){r.value||(r.value=!0,setTimeout(u,16))}function u(){const p=new Event("keydown");p.key="k",p.metaKey=!0,window.dispatchEvent(p),setTimeout(()=>{document.querySelector(".DocSearch-Modal")||u()},16)}const h=ne(!1),d="";return(p,_)=>{var y;return T(),R("div",Up,[b(d)==="local"?(T(),R(le,{key:0},[h.value?(T(),H(b(e),{key:0,onClose:_[0]||(_[0]=S=>h.value=!1)})):B("",!0),k("div",jp,[U(ga,{onClick:_[1]||(_[1]=S=>h.value=!0)})])],64)):b(d)==="algolia"?(T(),R(le,{key:1},[r.value?(T(),H(b(t),{key:0,algolia:((y=b(n).search)==null?void 0:y.options)??b(n).algolia,onVnodeBeforeMount:_[2]||(_[2]=S=>o.value=!0)},null,8,["algolia"])):B("",!0),o.value?B("",!0):(T(),R("div",Hp,[U(ga,{onClick:a})]))],64)):B("",!0)])}}}),zp=j({__name:"VPNavBarSocialLinks",setup(s){const{theme:e}=se();return(t,n)=>b(e).socialLinks?(T(),H(Vi,{key:0,class:"VPNavBarSocialLinks",links:b(e).socialLinks},null,8,["links"])):B("",!0)}}),Gp=q(zp,[["__scopeId","data-v-ef6192dc"]]),Kp=["href","rel","target"],Wp=["innerHTML"],Qp={key:2},Xp=j({__name:"VPNavBarTitle",setup(s){const{site:e,theme:t}=se(),{hasSidebar:n}=lt(),{currentLang:r}=Qn(),o=W(()=>{var h;return typeof t.value.logoLink=="string"?t.value.logoLink:(h=t.value.logoLink)==null?void 0:h.link}),a=W(()=>{var h;return typeof t.value.logoLink=="string"||(h=t.value.logoLink)==null?void 0:h.rel}),u=W(()=>{var h;return typeof t.value.logoLink=="string"||(h=t.value.logoLink)==null?void 0:h.target});return(h,d)=>(T(),R("div",{class:ue(["VPNavBarTitle",{"has-sidebar":b(n)}])},[k("a",{class:"title",href:o.value??b(Ai)(b(r).link),rel:a.value,target:u.value},[C(h.$slots,"nav-bar-title-before",{},void 0,!0),b(t).logo?(T(),H(ks,{key:0,class:"logo",image:b(t).logo},null,8,["image"])):B("",!0),b(t).siteTitle?(T(),R("span",{key:1,innerHTML:b(t).siteTitle},null,8,Wp)):b(t).siteTitle===void 0?(T(),R("span",Qp,Z(b(e).title),1)):B("",!0),C(h.$slots,"nav-bar-title-after",{},void 0,!0)],8,Kp)],2))}}),Yp=q(Xp,[["__scopeId","data-v-d4488dd0"]]),Jp={class:"items"},Zp={class:"title"},em=j({__name:"VPNavBarTranslations",setup(s){const{theme:e}=se(),{localeLinks:t,currentLang:n}=Qn({correspondingLink:!0});return(r,o)=>b(t).length&&b(n).label?(T(),H(Si,{key:0,class:"VPNavBarTranslations",icon:"vpi-languages",label:b(e).langMenuLabel||"Change language"},{default:L(()=>[k("div",Jp,[k("p",Zp,Z(b(n).label),1),(T(!0),R(le,null,Ve(b(t),a=>(T(),H(Qs,{key:a.link,item:a},null,8,["item"]))),128))])]),_:1},8,["label"])):B("",!0)}}),tm=q(em,[["__scopeId","data-v-acee064b"]]),nm={class:"wrapper"},sm={class:"container"},rm={class:"title"},im={class:"content"},om={class:"content-body"},am=j({__name:"VPNavBar",props:{isScreenOpen:{type:Boolean}},emits:["toggle-screen"],setup(s){const e=s,{y:t}=kl(),{isHome:n,hasSidebar:r}=lt(),o=ne({});return Ii(()=>{o.value={"has-sidebar":r.value,home:n.value,top:t.value===0,"screen-open":e.isScreenOpen}}),(a,u)=>(T(),R("div",{class:ue(["VPNavBar",o.value])},[k("div",nm,[k("div",sm,[k("div",rm,[U(Yp,null,{"nav-bar-title-before":L(()=>[C(a.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":L(()=>[C(a.$slots,"nav-bar-title-after",{},void 0,!0)]),_:3})]),k("div",im,[k("div",om,[C(a.$slots,"nav-bar-content-before",{},void 0,!0),U(qp,{class:"search"}),U(Op,{class:"menu"}),U(tm,{class:"translations"}),U(zf,{class:"appearance"}),U(Gp,{class:"social-links"}),U(Pp,{class:"extra"}),C(a.$slots,"nav-bar-content-after",{},void 0,!0),U(Rp,{class:"hamburger",active:a.isScreenOpen,onClick:u[0]||(u[0]=h=>a.$emit("toggle-screen"))},null,8,["active"])])])])]),u[1]||(u[1]=k("div",{class:"divider"},[k("div",{class:"divider-line"})],-1))],2))}}),lm=q(am,[["__scopeId","data-v-cb5e22fa"]]),um={key:0,class:"VPNavScreenAppearance"},cm={class:"text"},hm=j({__name:"VPNavScreenAppearance",setup(s){const{site:e,theme:t}=se();return(n,r)=>b(e).appearance&&b(e).appearance!=="force-dark"&&b(e).appearance!=="force-auto"?(T(),R("div",um,[k("p",cm,Z(b(t).darkModeSwitchLabel||"Appearance"),1),U(bi)])):B("",!0)}}),dm=q(hm,[["__scopeId","data-v-a3e2920d"]]),fm=["innerHTML"],pm=j({__name:"VPNavScreenMenuLink",props:{item:{}},setup(s){const e=Ws("close-screen");return(t,n)=>(T(),H(Xe,{class:"VPNavScreenMenuLink",href:t.item.link,target:t.item.target,rel:t.item.rel,"no-icon":t.item.noIcon,onClick:b(e)},{default:L(()=>[k("span",{innerHTML:t.item.text},null,8,fm)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),mm=q(pm,[["__scopeId","data-v-fa963d97"]]),gm=["innerHTML"],_m=j({__name:"VPNavScreenMenuGroupLink",props:{item:{}},setup(s){const e=Ws("close-screen");return(t,n)=>(T(),H(Xe,{class:"VPNavScreenMenuGroupLink",href:t.item.link,target:t.item.target,rel:t.item.rel,"no-icon":t.item.noIcon,onClick:b(e)},{default:L(()=>[k("span",{innerHTML:t.item.text},null,8,gm)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),xl=q(_m,[["__scopeId","data-v-e04f3e85"]]),vm={class:"VPNavScreenMenuGroupSection"},ym={key:0,class:"title"},Em=j({__name:"VPNavScreenMenuGroupSection",props:{text:{},items:{}},setup(s){return(e,t)=>(T(),R("div",vm,[e.text?(T(),R("p",ym,Z(e.text),1)):B("",!0),(T(!0),R(le,null,Ve(e.items,n=>(T(),H(xl,{key:n.text,item:n},null,8,["item"]))),128))]))}}),Tm=q(Em,[["__scopeId","data-v-7dfe209c"]]),Im=["aria-controls","aria-expanded"],wm=["innerHTML"],Am=["id"],bm={key:0,class:"item"},Pm={key:1,class:"item"},Sm={key:2,class:"group"},Vm=j({__name:"VPNavScreenMenuGroup",props:{text:{},items:{}},setup(s){const e=s,t=ne(!1),n=W(()=>`NavScreenGroup-${e.text.replace(" ","-").toLowerCase()}`);function r(){t.value=!t.value}return(o,a)=>(T(),R("div",{class:ue(["VPNavScreenMenuGroup",{open:t.value}])},[k("button",{class:"button","aria-controls":n.value,"aria-expanded":t.value,onClick:r},[k("span",{class:"button-text",innerHTML:o.text},null,8,wm),a[0]||(a[0]=k("span",{class:"vpi-plus button-icon"},null,-1))],8,Im),k("div",{id:n.value,class:"items"},[(T(!0),R(le,null,Ve(o.items,u=>(T(),R(le,{key:JSON.stringify(u)},["link"in u?(T(),R("div",bm,[U(xl,{item:u},null,8,["item"])])):"component"in u?(T(),R("div",Pm,[(T(),H(Qe(u.component),pt({ref_for:!0},u.props,{"screen-menu":""}),null,16))])):(T(),R("div",Sm,[U(Tm,{text:u.text,items:u.items},null,8,["text","items"])]))],64))),128))],8,Am)],2))}}),Rm=q(Vm,[["__scopeId","data-v-d3547da8"]]),km={key:0,class:"VPNavScreenMenu"},Cm=j({__name:"VPNavScreenMenu",setup(s){const{theme:e}=se();return(t,n)=>b(e).nav?(T(),R("nav",km,[(T(!0),R(le,null,Ve(b(e).nav,r=>(T(),R(le,{key:JSON.stringify(r)},["link"in r?(T(),H(mm,{key:0,item:r},null,8,["item"])):"component"in r?(T(),H(Qe(r.component),pt({key:1,ref_for:!0},r.props,{"screen-menu":""}),null,16)):(T(),H(Rm,{key:2,text:r.text||"",items:r.items},null,8,["text","items"]))],64))),128))])):B("",!0)}}),Dm=j({__name:"VPNavScreenSocialLinks",setup(s){const{theme:e}=se();return(t,n)=>b(e).socialLinks?(T(),H(Vi,{key:0,class:"VPNavScreenSocialLinks",links:b(e).socialLinks},null,8,["links"])):B("",!0)}}),Nm={class:"list"},Lm=j({__name:"VPNavScreenTranslations",setup(s){const{localeLinks:e,currentLang:t}=Qn({correspondingLink:!0}),n=ne(!1);function r(){n.value=!n.value}return(o,a)=>b(e).length&&b(t).label?(T(),R("div",{key:0,class:ue(["VPNavScreenTranslations",{open:n.value}])},[k("button",{class:"title",onClick:r},[a[0]||(a[0]=k("span",{class:"vpi-languages icon lang"},null,-1)),_e(" "+Z(b(t).label)+" ",1),a[1]||(a[1]=k("span",{class:"vpi-chevron-down icon chevron"},null,-1))]),k("ul",Nm,[(T(!0),R(le,null,Ve(b(e),u=>(T(),R("li",{key:u.link,class:"item"},[U(Xe,{class:"link",href:u.link},{default:L(()=>[_e(Z(u.text),1)]),_:2},1032,["href"])]))),128))])],2)):B("",!0)}}),Mm=q(Lm,[["__scopeId","data-v-516e4bc3"]]),Om={class:"container"},$m=j({__name:"VPNavScreen",props:{open:{type:Boolean}},setup(s){const e=ne(null),t=Cl(Kn?document.body:null);return(n,r)=>(T(),H(yi,{name:"fade",onEnter:r[0]||(r[0]=o=>t.value=!0),onAfterLeave:r[1]||(r[1]=o=>t.value=!1)},{default:L(()=>[n.open?(T(),R("div",{key:0,class:"VPNavScreen",ref_key:"screen",ref:e,id:"VPNavScreen"},[k("div",Om,[C(n.$slots,"nav-screen-content-before",{},void 0,!0),U(Cm,{class:"menu"}),U(Mm,{class:"translations"}),U(dm,{class:"appearance"}),U(Dm,{class:"social-links"}),C(n.$slots,"nav-screen-content-after",{},void 0,!0)])],512)):B("",!0)]),_:3}))}}),xm=q($m,[["__scopeId","data-v-2dd6d0c7"]]),Fm={key:0,class:"VPNav"},Bm=j({__name:"VPNav",setup(s){const{isScreenOpen:e,closeScreen:t,toggleScreen:n}=Mf(),{frontmatter:r}=se(),o=W(()=>r.value.navbar!==!1);return Dl("close-screen",t),Ks(()=>{Kn&&document.documentElement.classList.toggle("hide-nav",!o.value)}),(a,u)=>o.value?(T(),R("header",Fm,[U(lm,{"is-screen-open":b(e),onToggleScreen:b(n)},{"nav-bar-title-before":L(()=>[C(a.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":L(()=>[C(a.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":L(()=>[C(a.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":L(()=>[C(a.$slots,"nav-bar-content-after",{},void 0,!0)]),_:3},8,["is-screen-open","onToggleScreen"]),U(xm,{open:b(e)},{"nav-screen-content-before":L(()=>[C(a.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":L(()=>[C(a.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3},8,["open"])])):B("",!0)}}),Um=q(Bm,[["__scopeId","data-v-7ad780c2"]]),jm=["role","tabindex"],Hm={key:1,class:"items"},qm=j({__name:"VPSidebarItem",props:{item:{},depth:{}},setup(s){const e=s,{collapsed:t,collapsible:n,isLink:r,isActiveLink:o,hasActiveLink:a,hasChildren:u,toggle:h}=zh(W(()=>e.item)),d=W(()=>u.value?"section":"div"),p=W(()=>r.value?"a":"div"),_=W(()=>u.value?e.depth+2===7?"p":`h${e.depth+2}`:"p"),y=W(()=>r.value?void 0:"button"),S=W(()=>[[`level-${e.depth}`],{collapsible:n.value},{collapsed:t.value},{"is-link":r.value},{"is-active":o.value},{"has-active":a.value}]);function M(N){"key"in N&&N.key!=="Enter"||!e.item.link&&h()}function x(){e.item.link&&h()}return(N,X)=>{const K=bt("VPSidebarItem",!0);return T(),H(Qe(d.value),{class:ue(["VPSidebarItem",S.value])},{default:L(()=>[N.item.text?(T(),R("div",pt({key:0,class:"item",role:y.value},fh(N.item.items?{click:M,keydown:M}:{},!0),{tabindex:N.item.items&&0}),[X[1]||(X[1]=k("div",{class:"indicator"},null,-1)),N.item.link?(T(),H(Xe,{key:0,tag:p.value,class:"link",href:N.item.link,rel:N.item.rel,target:N.item.target},{default:L(()=>[(T(),H(Qe(_.value),{class:"text",innerHTML:N.item.text},null,8,["innerHTML"]))]),_:1},8,["tag","href","rel","target"])):(T(),H(Qe(_.value),{key:1,class:"text",innerHTML:N.item.text},null,8,["innerHTML"])),N.item.collapsed!=null&&N.item.items&&N.item.items.length?(T(),R("div",{key:2,class:"caret",role:"button","aria-label":"toggle section",onClick:x,onKeydown:ph(x,["enter"]),tabindex:"0"},X[0]||(X[0]=[k("span",{class:"vpi-chevron-right caret-icon"},null,-1)]),32)):B("",!0)],16,jm)):B("",!0),N.item.items&&N.item.items.length?(T(),R("div",Hm,[N.depth<5?(T(!0),R(le,{key:0},Ve(N.item.items,ee=>(T(),H(K,{key:ee.text,item:ee,depth:N.depth+1},null,8,["item","depth"]))),128)):B("",!0)])):B("",!0)]),_:1},8,["class"])}}}),zm=q(qm,[["__scopeId","data-v-6b36a2fd"]]),Gm=j({__name:"VPSidebarGroup",props:{items:{}},setup(s){const e=ne(!0);let t=null;return Ke(()=>{t=setTimeout(()=>{t=null,e.value=!1},300)}),mh(()=>{t!=null&&(clearTimeout(t),t=null)}),(n,r)=>(T(!0),R(le,null,Ve(n.items,o=>(T(),R("div",{key:o.text,class:ue(["group",{"no-transition":e.value}])},[U(zm,{item:o,depth:0},null,8,["item"])],2))),128))}}),Km=q(Gm,[["__scopeId","data-v-a84b7c21"]]),Wm={class:"nav",id:"VPSidebarNav","aria-labelledby":"sidebar-aria-label",tabindex:"-1"},Qm=j({__name:"VPSidebar",props:{open:{type:Boolean}},setup(s){const{sidebarGroups:e,hasSidebar:t}=lt(),n=s,r=ne(null),o=Cl(Kn?document.body:null);ze([n,r],()=>{var u;n.open?(o.value=!0,(u=r.value)==null||u.focus()):o.value=!1},{immediate:!0,flush:"post"});const a=ne(0);return ze(e,()=>{a.value+=1},{deep:!0}),(u,h)=>b(t)?(T(),R("aside",{key:0,class:ue(["VPSidebar",{open:u.open}]),ref_key:"navEl",ref:r,onClick:h[0]||(h[0]=gh(()=>{},["stop"]))},[h[2]||(h[2]=k("div",{class:"curtain"},null,-1)),k("nav",Wm,[h[1]||(h[1]=k("span",{class:"visually-hidden",id:"sidebar-aria-label"}," Sidebar Navigation ",-1)),C(u.$slots,"sidebar-nav-before",{},void 0,!0),(T(),H(Km,{items:b(e),key:a.value},null,8,["items"])),C(u.$slots,"sidebar-nav-after",{},void 0,!0)])],2)):B("",!0)}}),Xm=q(Qm,[["__scopeId","data-v-606f96d3"]]),Ym=j({__name:"VPSkipLink",setup(s){const{theme:e}=se(),t=Wn(),n=ne();ze(()=>t.path,()=>n.value.focus());function r({target:o}){const a=document.getElementById(decodeURIComponent(o.hash).slice(1));if(a){const u=()=>{a.removeAttribute("tabindex"),a.removeEventListener("blur",u)};a.setAttribute("tabindex","-1"),a.addEventListener("blur",u),a.focus(),window.scrollTo(0,0)}}return(o,a)=>(T(),R(le,null,[k("span",{ref_key:"backToTop",ref:n,tabindex:"-1"},null,512),k("a",{href:"#VPContent",class:"VPSkipLink visually-hidden",onClick:r},Z(b(e).skipToContentLabel||"Skip to content"),1)],64))}}),Jm=q(Ym,[["__scopeId","data-v-fcbfc0e0"]]),Zm=j({__name:"Layout",setup(s){const{isOpen:e,open:t,close:n}=qh();Gh({closeSidebar:n});const{frontmatter:r}=se(),o=_h(),a=W(()=>!!o["home-hero-image"]);return Dl("hero-image-slot-exists",a),(u,h)=>{const d=bt("Content");return b(r).layout!==!1?(T(),R("div",{key:0,class:ue(["Layout",b(r).pageClass])},[C(u.$slots,"layout-top",{},void 0,!0),U(Jm),U(Ih,{class:"backdrop",show:b(e),onClick:b(n)},null,8,["show","onClick"]),U(Um,null,{"nav-bar-title-before":L(()=>[C(u.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":L(()=>[C(u.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":L(()=>[C(u.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":L(()=>[C(u.$slots,"nav-bar-content-after",{},void 0,!0)]),"nav-screen-content-before":L(()=>[C(u.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":L(()=>[C(u.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3}),U(Lf,{open:b(e),onOpenMenu:b(t)},null,8,["open","onOpenMenu"]),U(Xm,{open:b(e)},{"sidebar-nav-before":L(()=>[C(u.$slots,"sidebar-nav-before",{},void 0,!0)]),"sidebar-nav-after":L(()=>[C(u.$slots,"sidebar-nav-after",{},void 0,!0)]),_:3},8,["open"]),U(yf,null,{"page-top":L(()=>[C(u.$slots,"page-top",{},void 0,!0)]),"page-bottom":L(()=>[C(u.$slots,"page-bottom",{},void 0,!0)]),"not-found":L(()=>[C(u.$slots,"not-found",{},void 0,!0)]),"home-hero-before":L(()=>[C(u.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":L(()=>[C(u.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":L(()=>[C(u.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":L(()=>[C(u.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":L(()=>[C(u.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":L(()=>[C(u.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":L(()=>[C(u.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":L(()=>[C(u.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":L(()=>[C(u.$slots,"home-features-after",{},void 0,!0)]),"doc-footer-before":L(()=>[C(u.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":L(()=>[C(u.$slots,"doc-before",{},void 0,!0)]),"doc-after":L(()=>[C(u.$slots,"doc-after",{},void 0,!0)]),"doc-top":L(()=>[C(u.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":L(()=>[C(u.$slots,"doc-bottom",{},void 0,!0)]),"aside-top":L(()=>[C(u.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":L(()=>[C(u.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":L(()=>[C(u.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":L(()=>[C(u.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":L(()=>[C(u.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":L(()=>[C(u.$slots,"aside-ads-after",{},void 0,!0)]),_:3}),U(Af),C(u.$slots,"layout-bottom",{},void 0,!0)],2)):(T(),H(d,{key:1}))}}}),eg=q(Zm,[["__scopeId","data-v-4539713c"]]),tg={Layout:eg,enhanceApp:({app:s})=>{s.component("Badge",yh)}},ng={class:"giscus-comments-container"},sg={class:"giscus-comments-placeholder"},rg={__name:"GiscusComments",setup(s){const e=ne(!1),t=ne(null),n=Wn(),{isDark:r}=Gs(),o=W(()=>r.value?"dark_dimmed":"light");function a(){if(t.value){t.value.innerHTML="";const u=document.createElement("script");u.src="https://giscus.app/client.js",u.setAttribute("data-repo","HolyBearTW/holybear.me"),u.setAttribute("data-repo-id","R_kgDOJmguVg"),u.setAttribute("data-category","General"),u.setAttribute("data-category-id","DIC_kwDOJmguVs4Cqo90"),u.setAttribute("data-mapping","pathname"),u.setAttribute("data-strict","0"),u.setAttribute("data-reactions-enabled","1"),u.setAttribute("data-emit-metadata","0"),u.setAttribute("data-input-position","bottom"),u.setAttribute("data-theme",o.value),u.setAttribute("data-lang","zh-TW"),u.setAttribute("crossorigin","anonymous"),u.async=!0,t.value.appendChild(u),e.value=!0}}return Ke(()=>{a()}),ze(()=>n.path,()=>{e.value=!1,a()}),ze(o,u=>{{const h=document.querySelector("iframe.giscus-frame");h&&h.contentWindow&&h.contentWindow.postMessage({giscus:{setConfig:{theme:u}}},"https://giscus.app")}},{immediate:!0}),(u,h)=>(T(),R("div",ng,[pa(k("div",sg,h[0]||(h[0]=[k("p",null,"正在載入留言...",-1),k("div",{class:"spinner"},null,-1)]),512),[[ma,!e.value]]),pa(k("div",{ref_key:"giscusContainer",ref:t,class:"giscus-actual-comments"},null,512),[[ma,e.value]])]))}},ig=q(rg,[["__scopeId","data-v-0991216c"]]);function og(s){const e=ne(0),t=ne(0),n=ne(!0);async function r(){{n.value=!1;return}}async function o(u){}async function a(u){}return{up:e,down:t,vote:o,unvote:a,loading:n,fetchVotes:r}}const ag={style:{"font-size":"0.95em",color:"#666","margin-bottom":"10px",background:"#f8f8f8",padding:"0.5em"}},lg={key:0,class:"vote-panel"},ug=["disabled"],cg={key:0},hg={key:1},dg=["disabled"],fg={key:0},pg={key:1},mg={__name:"VotePanel",setup(s){const{page:e}=Gs(),t=W(()=>e.value.relativePath.replaceAll("/","__")),n=ne(null),r=ne(null),o=ne(!1);async function a(h){var d,p,_,y,S,M,x;if(n.value=og(),console.log("useVote 回傳:",n.value),console.log("voteState.value.up:",(d=n.value)==null?void 0:d.up),console.log("voteState.value.down:",(p=n.value)==null?void 0:p.down),console.log("voteState.value.loading:",(_=n.value)==null?void 0:_.loading),console.log("voteState.value.fetchVotes:",(y=n.value)==null?void 0:y.fetchVotes),r.value=localStorage.getItem("vote_"+h)||null,n.value&&typeof n.value.fetchVotes=="function")try{await n.value.fetchVotes(),console.log("fetchVotes 完成:",{up:(S=n.value.up)==null?void 0:S.value,down:(M=n.value.down)==null?void 0:M.value,loading:(x=n.value.loading)==null?void 0:x.value})}catch(N){console.error("fetchVotes 失敗:",N)}else console.error("voteState.value 沒 fetchVotes，useVote 應該沒正確 return！")}Ke(async()=>{o.value=!0,await a(t.value)}),ze(t,async h=>{await a(h)});async function u(h){var d;!n.value||(d=n.value.loading)!=null&&d.value||(r.value===h?(await n.value.unvote(h),r.value=null,localStorage.removeItem("vote_"+t.value)):(r.value&&await n.value.unvote(r.value),await n.value.vote(h),r.value=h,localStorage.setItem("vote_"+t.value,h)),await n.value.fetchVotes())}return(h,d)=>{var p,_,y,S,M,x,N,X,K,ee,he,ke,ye,w,m,v,E;return T(),R("div",null,[k("div",ag,[_e(" hydrated: "+Z(o.value?"yes":"no"),1),d[2]||(d[2]=k("br",null,null,-1)),_e(" voteState: "+Z(n.value.value?"ok":"not ready"),1),d[3]||(d[3]=k("br",null,null,-1)),_e(" typeof voteState.value.up: "+Z(typeof((p=n.value.value)==null?void 0:p.up)),1),d[4]||(d[4]=k("br",null,null,-1)),_e(" typeof voteState.value.down: "+Z(typeof((_=n.value.value)==null?void 0:_.down)),1),d[5]||(d[5]=k("br",null,null,-1)),_e(" voteState.value.up.value: "+Z((S=(y=n.value.value)==null?void 0:y.up)==null?void 0:S.value),1),d[6]||(d[6]=k("br",null,null,-1)),_e(" voteState.value.down.value: "+Z((x=(M=n.value.value)==null?void 0:M.down)==null?void 0:x.value),1),d[7]||(d[7]=k("br",null,null,-1)),_e(" voteState.value.loading.value: "+Z((X=(N=n.value.value)==null?void 0:N.loading)==null?void 0:X.value),1),d[8]||(d[8]=k("br",null,null,-1)),_e(" userVote: "+Z(r.value.value),1)]),o.value&&((K=n.value.value)!=null&&K.up)&&((ee=n.value.value)!=null&&ee.down)&&((he=n.value.value)==null?void 0:he.loading)!==void 0?(T(),R("div",lg,[k("button",{onClick:d[0]||(d[0]=I=>u("up")),disabled:(ke=n.value.value.loading)==null?void 0:ke.value,class:ue({active:r.value.value==="up"})},[d[9]||(d[9]=_e(" 👍 推 ")),(ye=n.value.value.loading)!=null&&ye.value?(T(),R("span",hg,"...")):(T(),R("span",cg,"("+Z((w=n.value.value.up)==null?void 0:w.value)+")",1))],10,ug),k("button",{onClick:d[1]||(d[1]=I=>u("down")),disabled:(m=n.value.value.loading)==null?void 0:m.value,class:ue({active:r.value.value==="down"})},[d[10]||(d[10]=_e(" 👎 噓 ")),(v=n.value.value.loading)!=null&&v.value?(T(),R("span",pg,"...")):(T(),R("span",fg,"("+Z((E=n.value.value.down)==null?void 0:E.value)+")",1))],10,dg)])):B("",!0)])}}},gg=q(mg,[["__scopeId","data-v-db816914"]]),_g=()=>{};var _a={};/**
 * @license
 ...
 */const Fl=function(s){const e=[];let t=0;for(let n=0;n<s.length;n++){let r=s.charCodeAt(n);r<128?e[t++]=r:r<2048?(e[t++]=r>>6|192,e[t++]=r&63|128):(r&64512)===55296&&n+1<s.length&&(s.charCodeAt(n+1)&64512)===56320?(r=65536+((r&1023)<<10)+(s.charCodeAt(++n)&1023),e[t++]=r>>18|240,e[t++]=r>>12&63|128,e[t++]=r>>6&63|128,e[t++]=r&63|128):(e[t++]=r>>12|224,e[t++]=r>>6&63|128,e[t++]=r&63|128)}return e},vg=function(s){const e=[];let t=0,n=0;for(;t<s.length;){const r=s[t++];if(r<128)e[n++]=String.fromCharCode(r);else if(r>191&&r<224){const o=s[t++];e[n++]=String.fromCharCode((r&31)<<6|o&63)}else if(r>239&&r<365){const o=s[t++],a=s[t++],u=s[t++],h=((r&7)<<18|(o&63)<<12|(a&63)<<6|u&63)-65536;e[n++]=String.fromCharCode(55296+(h>>10)),e[n++]=String.fromCharCode(56320+(h&1023))}else{const o=s[t++],a=s[t++];e[n++]=String.fromCharCode((r&15)<<12|(o&63)<<6|a&63)}}return e.join("")},Bl={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(s,e){if(!Array.isArray(s))throw Error("encodeByteArray takes an array as a parameter");this.init_();const t=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,n=[];for(let r=0;r<s.length;r+=3){const o=s[r],a=r+1<s.length,u=a?s[r+1]:0,h=r+2<s.length,d=h?s[r+2]:0,p=o>>2,_=(o&3)<<4|u>>4;let y=(u&15)<<2|d>>6,S=d&63;h||(S=64,a||(y=64)),n.push(t[p],t[_],t[y],t[S])}return n.join("")},encodeString(s,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(s):this.encodeByteArray(Fl(s),e)},decodeString(s,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(s):vg(this.decodeStringToByteArray(s,e))},decodeStringToByteArray(s,e){this.init_();const t=e?this.charToByteMapWebSafe_:this.charToByteMap_,n=[];for(let r=0;r<s.length;){const o=t[s.charAt(r++)],u=r<s.length?t[s.charAt(r)]:0;++r;const d=r<s.length?t[s.charAt(r)]:64;++r;const _=r<s.length?t[s.charAt(r)]:64;if(++r,o==null||u==null||d==null||_==null)throw new yg;const y=o<<2|u>>4;if(n.push(y),d!==64){const S=u<<4&240|d>>2;if(n.push(S),_!==64){const M=d<<6&192|_;n.push(M)}}}return n},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let s=0;s<this.ENCODED_VALS.length;s++)this.byteToCharMap_[s]=this.ENCODED_VALS.charAt(s),this.charToByteMap_[this.byteToCharMap_[s]]=s,this.byteToCharMapWebSafe_[s]=this.ENCODED_VALS_WEBSAFE.charAt(s),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[s]]=s,s>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(s)]=s,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(s)]=s)}}};class yg extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Eg=function(s){const e=Fl(s);return Bl.encodeByteArray(e,!0)},Cs=function(s){return Eg(s).replace(/\./g,"")},Tg=function(s){try{return Bl.decodeString(s,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wg=()=>Ig().__FIREBASE_DEFAULTS__,Ag=()=>{if(typeof process>"u"||typeof _a>"u")return;const s=_a.__FIREBASE_DEFAULTS__;if(s)return JSON.parse(s)},bg=()=>{if(typeof document>"u")return;let s;try{s=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=s&&Tg(s[1]);return e&&JSON.parse(e)},Ri=()=>{try{return _g()||wg()||Ag()||bg()}catch(s){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${s}`);return}},Pg=s=>{var e,t;return(t=(e=Ri())===null||e===void 0?void 0:e.emulatorHosts)===null||t===void 0?void 0:t[s]},Sg=s=>{const e=Pg(s);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const n=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),n]:[e.substring(0,t),n]},Ul=()=>{var s;return(s=Ri())===null||s===void 0?void 0:s.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ki(s){return s.endsWith(".cloudworkstations.dev")}async function Rg(s){return(await fetch(s,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kg(s,e){if(s.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const t={alg:"none",type:"JWT"},n=e||"demo-project",r=s.iat||0,o=s.sub||s.user_id;if(!o)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const a=Object.assign({iss:`https://securetoken.google.com/${n}`,aud:n,iat:r,exp:r+3600,auth_time:r,sub:o,user_id:o,firebase:{sign_in_provider:"custom",identities:{}}},s);return[Cs(JSON.stringify(t)),Cs(JSON.stringify(a)),""].join(".")}const Dn={};function Cg(){const s={prod:[],emulator:[]};for(const e of Object.keys(Dn))Dn[e]?s.emulator.push(e):s.prod.push(e);return s}function Dg(s){let e=document.getElementById(s),t=!1;return e||(e=document.createElement("div"),e.setAttribute("id",s),t=!0),{created:t,element:e}}let va=!1;function Ng(s,e){if(typeof window>"u"||typeof document>"u"||!ki(window.location.host)||Dn[s]===e||Dn[s]||va)return;Dn[s]=e;function t(y){return`__firebase__banner__${y}`}const n="__firebase__banner",o=Cg().prod.length>0;function a(){const y=document.getElementById(n);y&&y.remove()}function u(y){y.style.display="flex",y.style.background="#7faaf0",y.style.position="fixed",y.style.bottom="5px",y.style.left="5px",y.style.padding=".5em",y.style.borderRadius="5px",y.style.alignItems="center"}function h(y,S){y.setAttribute("width","24"),y.setAttribute("id",S),y.setAttribute("height","24"),y.setAttribute("viewBox","0 0 24 24"),y.setAttribute("fill","none"),y.style.marginLeft="-6px"}function d(){const y=document.createElement("span");return y.style.cursor="pointer",y.style.marginLeft="16px",y.style.fontSize="24px",y.innerHTML=" &times;",y.onclick=()=>{va=!0,a()},y}function p(y,S){y.setAttribute("id",S),y.innerText="Learn more",y.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",y.setAttribute("target","__blank"),y.style.paddingLeft="5px",y.style.textDecoration="underline"}function _(){const y=Dg(n),S=t("text"),M=document.getElementById(S)||document.createElement("span"),x=t("learnmore"),N=document.getElementById(x)||document.createElement("a"),X=t("preprendIcon"),K=document.getElementById(X)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(y.created){const ee=y.element;u(ee),p(N,x);const he=d();h(K,X),ee.append(K,M,N,he),document.body.appendChild(ee)}o?(M.innerText="Preview backend disconnected.",K.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lg(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Mg(){var s;const e=(s=Ri())===null||s===void 0?void 0:s.forceEnvironment;if(e==="node")return!0;if(e==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function Og(){return!Mg()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function $g(){try{return typeof indexedDB=="object"}catch{return!1}}function xg(){return new Promise((s,e)=>{try{let t=!0;const n="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(n);r.onsuccess=()=>{r.result.close(),t||self.indexedDB.deleteDatabase(n),s(!0)},r.onupgradeneeded=()=>{t=!1},r.onerror=()=>{var o;e(((o=r.error)===null||o===void 0?void 0:o.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fg="FirebaseError";class on extends Error{constructor(e,t,n){super(t),this.code=e,this.customData=n,this.name=Fg,Object.setPrototypeOf(this,on.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,jl.prototype.create)}}class jl{constructor(e,t,n){this.service=e,this.serviceName=t,this.errors=n}create(e,...t){const n=t[0]||{},r=`${this.service}/${e}`,o=this.errors[e],a=o?Bg(o,n):"Error",u=`${this.serviceName}: ${a} (${r}).`;return new on(r,u,n)}}function Bg(s,e){return s.replace(Ug,(t,n)=>{const r=e[n];return r!=null?String(r):`<${n}?>`})}const Ug=/\{\$([^}]+)}/g;function Ds(s,e){if(s===e)return!0;const t=Object.keys(s),n=Object.keys(e);for(const r of t){if(!n.includes(r))return!1;const o=s[r],a=e[r];if(ya(o)&&ya(a)){if(!Ds(o,a))return!1}else if(o!==a)return!1}for(const r of n)if(!t.includes(r))return!1;return!0}function ya(s){return s!==null&&typeof s=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jg{constructor(e,t){this.name=e,this.container=t,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const t=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(t)){const n=new Vg;if(this.instancesDeferred.set(t,n),this.isInitialized(t)||this.shouldAutoInitialize())try{const r=this.getOrInitializeService({instanceIdentifier:t});r&&n.resolve(r)}catch{}}return this.instancesDeferred.get(t).promise}getImmediate(e){var t;const n=this.normalizeInstanceIdentifier(e==null?void 0:e.identifier),r=(t=e==null?void 0:e.optional)!==null&&t!==void 0?t:!1;if(this.isInitialized(n)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:n})}catch(o){if(r)return null;throw o}else{if(r)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,!!this.shouldAutoInitialize()){if(qg(e))try{this.getOrInitializeService({instanceIdentifier:Dt})}catch{}for(const[t,n]of this.instancesDeferred.entries()){const r=this.normalizeInstanceIdentifier(t);try{const o=this.getOrInitializeService({instanceIdentifier:r});n.resolve(o)}catch{}}}}clearInstance(e=Dt){this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)}async delete(){const e=Array.from(this.instances.values());await Promise.all([...e.filter(t=>"INTERNAL"in t).map(t=>t.INTERNAL.delete()),...e.filter(t=>"_delete"in t).map(t=>t._delete())])}isComponentSet(){return this.component!=null}isInitialized(e=Dt){return this.instances.has(e)}getOptions(e=Dt){return this.instancesOptions.get(e)||{}}initialize(e={}){const{options:t={}}=e,n=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(n))throw Error(`${this.name}(${n}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const r=this.getOrInitializeService({instanceIdentifier:n,options:t});for(const[o,a]of this.instancesDeferred.entries()){const u=this.normalizeInstanceIdentifier(o);n===u&&a.resolve(r)}return r}onInit(e,t){var n;const r=this.normalizeInstanceIdentifier(t),o=(n=this.onInitCallbacks.get(r))!==null&&n!==void 0?n:new Set;o.add(e),this.onInitCallbacks.set(r,o);const a=this.instances.get(r);return a&&e(a,r),()=>{o.delete(e)}}invokeOnInitCallbacks(e,t){const n=this.onInitCallbacks.get(t);if(n)for(const r of n)try{r(e,t)}catch{}}getOrInitializeService({instanceIdentifier:e,options:t={}}){let n=this.instances.get(e);if(!n&&this.component&&(n=this.component.instanceFactory(this.container,{instanceIdentifier:Hg(e),options:t}),this.instances.set(e,n),this.instancesOptions.set(e,t),this.invokeOnInitCallbacks(n,e),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,e,n)}catch{}return n||null}normalizeInstanceIdentifier(e=Dt){return this.component?this.component.multipleInstances?e:Dt:e}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function Hg(s){return s===Dt?void 0:s}function qg(s){return s.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var oe;(function(s){s[s.DEBUG=0]="DEBUG",s[s.VERBOSE=1]="VERBOSE",s[s.INFO=2]="INFO",s[s.WARN=3]="WARN",s[s.ERROR=4]="ERROR",s[s.SILENT=5]="SILENT"})(oe||(oe={}));const Gg={debug:oe.DEBUG,verbose:oe.VERBOSE,info:oe.INFO,warn:oe.WARN,error:oe.ERROR,silent:oe.SILENT},Kg=oe.INFO,Wg={[oe.DEBUG]:"log",[oe.VERBOSE]:"log",[oe.INFO]:"info",[oe.WARN]:"warn",[oe.ERROR]:"error"},Qg=(s,e,...t)=>{if(e<s.logLevel)return;const n=new Date().toISOString(),r=Wg[e];if(r)console[r](`[${n}]  ${s.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Hl{constructor(e){this.name=e,this._logLevel=Kg,this._logHandler=Qg,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in oe))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Gg[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,oe.DEBUG,...e),this._logHandler(this,oe.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,oe.VERBOSE,...e),this._logHandler(this,oe.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,oe.INFO,...e),this._logHandler(this,oe.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,oe.WARN,...e),this._logHandler(this,oe.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,oe.ERROR,...e),this._logHandler(this,oe.ERROR,...e)}}const Xg=(s,e)=>e.some(t=>s instanceof t);let Ea,Ta;function Yg(){return Ea||(Ea=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Jg(){return Ta||(Ta=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const ql=new WeakMap,Yr=new WeakMap,zl=new WeakMap,xr=new WeakMap,Ci=new WeakMap;function Zg(s){const e=new Promise((t,n)=>{const r=()=>{s.removeEventListener("success",o),s.removeEventListener("error",a)},o=()=>{t(mt(s.result)),r()},a=()=>{n(s.error),r()};s.addEventListener("success",o),s.addEventListener("error",a)});return e.then(t=>{t instanceof IDBCursor&&ql.set(t,s)}).catch(()=>{}),Ci.set(e,s),e}function e_(s){if(Yr.has(s))return;const e=new Promise((t,n)=>{const r=()=>{s.removeEventListener("complete",o),s.removeEventListener("error",a),s.removeEventListener("abort",a)},o=()=>{t(),r()},a=()=>{n(s.error||new DOMException("AbortError","AbortError")),r()};s.addEventListener("complete",o),s.addEventListener("error",a),s.addEventListener("abort",a)});Yr.set(s,e)}let Jr={get(s,e,t){if(s instanceof IDBTransaction){if(e==="done")return Yr.get(s);if(e==="objectStoreNames")return s.objectStoreNames||zl.get(s);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return mt(s[e])},set(s,e,t){return s[e]=t,!0},has(s,e){return s instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in s}};function t_(s){Jr=s(Jr)}function n_(s){return s===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const n=s.call(Fr(this),e,...t);return zl.set(n,e.sort?e.sort():[e]),mt(n)}:Jg().includes(s)?function(...e){return s.apply(Fr(this),e),mt(ql.get(this))}:function(...e){return mt(s.apply(Fr(this),e))}}function s_(s){return typeof s=="function"?n_(s):(s instanceof IDBTransaction&&e_(s),Xg(s,Yg())?new Proxy(s,Jr):s)}function mt(s){if(s instanceof IDBRequest)return Zg(s);if(xr.has(s))return xr.get(s);const e=s_(s);return e!==s&&(xr.set(s,e),Ci.set(e,s)),e}const Fr=s=>Ci.get(s);function r_(s,e,{blocked:t,upgrade:n,blocking:r,terminated:o}={}){const a=indexedDB.open(s,e),u=mt(a);return n&&a.addEventListener("upgradeneeded",h=>{n(mt(a.result),h.oldVersion,h.newVersion,mt(a.transaction),h)}),t&&a.addEventListener("blocked",h=>t(h.oldVersion,h.newVersion,h)),u.then(h=>{o&&h.addEventListener("close",()=>o()),r&&h.addEventListener("versionchange",d=>r(d.oldVersion,d.newVersion,d))}).catch(()=>{}),u}const i_=["get","getKey","getAll","getAllKeys","count"],o_=["put","add","delete","clear"],Br=new Map;function Ia(s,e){if(!(s instanceof IDBDatabase&&!(e in s)&&typeof e=="string"))return;if(Br.get(e))return Br.get(e);const t=e.replace(/FromIndex$/,""),n=e!==t,r=o_.includes(t);if(!(t in(n?IDBIndex:IDBObjectStore).prototype)||!(r||i_.includes(t)))return;const o=async function(a,...u){const h=this.transaction(a,r?"readwrite":"readonly");let d=h.store;return n&&(d=d.index(u.shift())),(await Promise.all([d[t](...u),r&&h.done]))[0]};return Br.set(e,o),o}t_(s=>({...s,get:(e,t,n)=>Ia(e,t)||s.get(e,t,n),has:(e,t)=>!!Ia(e,t)||s.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class a_{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(l_(t)){const n=t.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(t=>t).join(" ")}}function l_(s){const e=s.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Zr="@firebase/app",wa="0.13.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const it=new Hl("@firebase/app"),u_="@firebase/app-compat",c_="@firebase/analytics-compat",h_="@firebase/analytics",d_="@firebase/app-check-compat",f_="@firebase/app-check",p_="@firebase/auth",m_="@firebase/auth-compat",g_="@firebase/database",__="@firebase/data-connect",v_="@firebase/database-compat",y_="@firebase/functions",E_="@firebase/functions-compat",T_="@firebase/installations",I_="@firebase/installations-compat",w_="@firebase/messaging",A_="@firebase/messaging-compat",b_="@firebase/performance",P_="@firebase/performance-compat",S_="@firebase/remote-config",V_="@firebase/remote-config-compat",R_="@firebase/storage",k_="@firebase/storage-compat",C_="@firebase/firestore",D_="@firebase/ai",N_="@firebase/firestore-compat",L_="firebase",M_="11.9.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ei="[DEFAULT]",O_={[Zr]:"fire-core",[u_]:"fire-core-compat",[h_]:"fire-analytics",[c_]:"fire-analytics-compat",[f_]:"fire-app-check",[d_]:"fire-app-check-compat",[p_]:"fire-auth",[m_]:"fire-auth-compat",[g_]:"fire-rtdb",[__]:"fire-data-connect",[v_]:"fire-rtdb-compat",[y_]:"fire-fn",[E_]:"fire-fn-compat",[T_]:"fire-iid",[I_]:"fire-iid-compat",[w_]:"fire-fcm",[A_]:"fire-fcm-compat",[b_]:"fire-perf",[P_]:"fire-perf-compat",[S_]:"fire-rc",[V_]:"fire-rc-compat",[R_]:"fire-gcs",[k_]:"fire-gcs-compat",[C_]:"fire-fst",[N_]:"fire-fst-compat",[D_]:"fire-vertex","fire-js":"fire-js",[L_]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ns=new Map,$_=new Map,ti=new Map;function Aa(s,e){try{s.container.addComponent(e)}catch(t){it.debug(`Component ${e.name} failed to register with FirebaseApp ${s.name}`,t)}}function Ls(s){const e=s.name;if(ti.has(e))return it.debug(`There were multiple attempts to register component ${e}.`),!1;ti.set(e,s);for(const t of Ns.values())Aa(t,s);for(const t of $_.values())Aa(t,s);return!0}function x_(s,e){const t=s.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),s.container.getProvider(e)}function F_(s){return s==null?!1:s.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const j_=M_;function Gl(s,e={}){let t=s;typeof e!="object"&&(e={name:e});const n=Object.assign({name:ei,automaticDataCollectionEnabled:!0},e),r=n.name;if(typeof r!="string"||!r)throw gt.create("bad-app-name",{appName:String(r)});if(t||(t=Ul()),!t)throw gt.create("no-options");const o=Ns.get(r);if(o){if(Ds(t,o.options)&&Ds(n,o.config))return o;throw gt.create("duplicate-app",{appName:r})}const a=new zg(r);for(const h of ti.values())a.addComponent(h);const u=new U_(t,n,a);return Ns.set(r,u),u}function H_(s=ei){const e=Ns.get(s);if(!e&&s===ei&&Ul())return Gl();if(!e)throw gt.create("no-app",{appName:s});return e}function Xt(s,e,t){var n;let r=(n=O_[s])!==null&&n!==void 0?n:s;t&&(r+=`-${t}`);const o=r.match(/\s|\//),a=e.match(/\s|\//);if(o||a){const u=[`Unable to register library "${r}" with version "${e}":`];o&&u.push(`library name "${r}" contains illegal characters (whitespace or "/")`),o&&a&&u.push("and"),a&&u.push(`version name "${e}" contains illegal characters (whitespace or "/")`),it.warn(u.join(" "));return}Ls(new $n(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const K_=1024,W_=30;class Q_{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Y_(t),this._heartbeatsCachePromise=this._storage.read().then(n=>(this._heartbeatsCache=n,n))}async triggerHeartbeat(){var e,t;try{const r=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),o=Pa();if(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===o||this._heartbeatsCache.heartbeats.some(a=>a.date===o))return;if(this._heartbeatsCache.heartbeats.push({date:o,agent:r}),this._heartbeatsCache.heartbeats.length>W_){const a=J_(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(a,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(n){it.warn(n)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Pa(),{heartbeatsToSend:n,unsentEntries:r}=X_(this._heartbeatsCache.heartbeats),o=Cs(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=t,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(t){return it.warn(t),""}}}function Pa(){return new Date().toISOString().substring(0,10)}function X_(s,e=K_){const t=[];let n=s.slice();for(const r of s){const o=t.find(a=>a.agent===r.agent);if(o){if(o.dates.push(r.date),Sa(t)>e){o.dates.pop();break}}else if(t.push({agent:r.agent,dates:[r.date]}),Sa(t)>e){t.pop();break}n=n.slice(1)}return{heartbeatsToSend:t,unsentEntries:n}}class Y_{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return $g()?xg().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await G_(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const r=await this.read();return ba(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const r=await this.read();return ba(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function Sa(s){return Cs(JSON.stringify({version:2,heartbeats:s})).length}function J_(s){if(s.length===0)return-1;let e=0,t=s[0].date;for(let n=1;n<s.length;n++)s[n].date<t&&(t=s[n].date,e=n);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Z_(s){Ls(new $n("platform-logger",e=>new a_(e),"PRIVATE")),Ls(new $n("heartbeat",e=>new Q_(e),"PRIVATE")),Xt(Zr,wa,s),Xt(Zr,wa,"esm2017"),Xt("fire-js","")}Z_("");var Va=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nu{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class ev{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(Oe.UNAUTHENTICATED))}shutdown(){}}class tv{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class nv{constructor(e){this.t=e,this.currentUser=Oe.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){ce(this.o===void 0,42304);let n=this.i;const r=h=>this.i!==n?(n=this.i,t(h)):Promise.resolve();let o=new vt;this.o=()=>{this.i++,this.currentUser=this.u(),o.resolve(),o=new vt,e.enqueueRetryable(()=>r(this.currentUser))};const a=()=>{const h=o;e.enqueueRetryable(async()=>{await h.promise,await r(this.currentUser)})},u=h=>{F("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=h,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(h=>u(h)),setTimeout(()=>{if(!this.auth){const h=this.t.getImmediate({optional:!0});h?u(h):(F("FirebaseAuthCredentialsProvider","Auth not yet detected"),o.resolve(),o=new vt)}},0),a()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(n=>this.i!==e?(F("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):n?(ce(typeof n.accessToken=="string",31837,{l:n}),new nu(n.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return ce(e===null||typeof e=="string",2055,{h:e}),new Oe(e)}}class sv{constructor(e,t,n){this.P=e,this.T=t,this.I=n,this.type="FirstParty",this.user=Oe.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const e=this.R();return e&&this.A.set("Authorization",e),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class rv{constructor(e,t,n){this.P=e,this.T=t,this.I=n}getToken(){return Promise.resolve(new sv(this.P,this.T,this.I))}start(e,t){e.enqueueRetryable(()=>t(Oe.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Ca{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class iv{constructor(e,t){this.V=t,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,F_(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,t){ce(this.o===void 0,3512);const n=o=>{o.error!=null&&F("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${o.error.message}`);const a=o.token!==this.m;return this.m=o.token,F("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?t(o.token):Promise.resolve()};this.o=o=>{e.enqueueRetryable(()=>n(o))};const r=o=>{F("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=o,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(o=>r(o)),setTimeout(()=>{if(!this.appCheck){const o=this.V.getImmediate({optional:!0});o?r(o):F("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new Ca(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(ce(typeof t.token=="string",44558,{tokenResult:t}),this.m=t.token,new Ca(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ov(s){const e=typeof self<"u"&&(self.crypto||self.msCrypto),t=new Uint8Array(s);if(e&&typeof e.getRandomValues=="function")e.getRandomValues(t);else for(let n=0;n<s;n++)t[n]=Math.floor(256*Math.random());return t}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ru{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=62*Math.floor(4.129032258064516);let n="";for(;n.length<20;){const r=ov(40);for(let o=0;o<r.length;++o)n.length<20&&r[o]<t&&(n+=e.charAt(r[o]%62))}return n}}function te(s,e){return s<e?-1:s>e?1:0}function si(s,e){let t=0;for(;t<s.length&&t<e.length;){const n=s.codePointAt(t),r=e.codePointAt(t);if(n!==r){if(n<128&&r<128)return te(n,r);{const o=su(),a=av(o.encode(Da(s,t)),o.encode(Da(e,t)));return a!==0?a:te(n,r)}}t+=n>65535?2:1}return te(s.length,e.length)}function Da(s,e){return s.codePointAt(e)>65535?s.substring(e,e+2):s.substring(e,e+1)}function av(s,e){for(let t=0;t<s.length&&t<e.length;++t)if(s[t]!==e[t])return te(s[t],e[t]);return te(s.length,e.length)}function Zt(s,e,t){return s.length===e.length&&s.every((n,r)=>t(n,e[r]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fn=-1;function uv(s,e){const t=s.toTimestamp().seconds,n=s.toTimestamp().nanoseconds+1,r=Y.fromTimestamp(n===1e9?new Ie(t+1,0):new Ie(t,n));return new yt(r,G.empty(),e)}function cv(s){return new yt(s.readTime,s.key,Fn)}class yt{constructor(e,t,n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}static min(){return new yt(Y.min(),G.empty(),Fn)}static max(){return new yt(Y.max(),G.empty(),Fn)}}function hv(s,e){let t=s.readTime.compareTo(e.readTime);return t!==0?t:(t=G.comparator(s.documentKey,e.documentKey),t!==0?t:te(s.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ln(s){if(s.code!==O.FAILED_PRECONDITION||s.message!==dv)throw s;F("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ni=-1;function Ys(s){return s==null}function Ms(s){return s===0&&1/s==-1/0}function mv(s){return typeof s=="number"&&Number.isInteger(s)&&!Ms(s)&&s<=Number.MAX_SAFE_INTEGER&&s>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iu="";function gv(s){let e="";for(let t=0;t<s.length;t++)e.length>0&&(e=Oa(e)),e=_v(s.get(t),e);return Oa(e)}function _v(s,e){let t=e;const n=s.length;for(let r=0;r<n;r++){const o=s.charAt(r);switch(o){case"\0":t+="";break;case iu:t+="";break;default:t+=o}}return t}function Oa(s){return s+iu+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lu="server_timestamp",uu="__type__",cu="__previous_value__",hu="__local_write_time__";function Li(s){var e,t;return((t=(((e=s==null?void 0:s.mapValue)===null||e===void 0?void 0:e.fields)||{})[uu])===null||t===void 0?void 0:t.stringValue)===lu}function Js(s){const e=s.mapValue.fields[cu];return Li(e)?Js(e):e}function Bn(s){const e=Et(s.mapValue.fields[hu].timestampValue);return new Ie(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $e{constructor(e,t,n,r,o,a,u){this.key=e,this.documentType=t,this.version=n,this.readTime=r,this.createTime=o,this.data=a,this.documentState=u}static newInvalidDocument(e){return new $e(e,0,Y.min(),Y.min(),Y.min(),Ue.empty(),0)}static newFoundDocument(e,t,n,r){return new $e(e,1,t,Y.min(),n,r,0)}static newNoDocument(e,t){return new $e(e,2,t,Y.min(),Y.min(),Ue.empty(),0)}static newUnknownDocument(e,t){return new $e(e,3,t,Y.min(),Y.min(),Ue.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(Y.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=Ue.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=Ue.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=Y.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof $e&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new $e(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fs{constructor(e,t="asc"){this.field=e,this.dir=t}}function wv(s,e){return s.dir===e.dir&&s.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mu{}class Te extends mu{constructor(e,t,n){super(),this.field=e,this.op=t,this.value=n}static create(e,t,n){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,n):new bv(e,t,n):t==="array-contains"?new Vv(e,n):t==="in"?new Rv(e,n):t==="not-in"?new kv(e,n):t==="array-contains-any"?new Cv(e,n):new Te(e,t,n)}static createKeyFieldInFilter(e,t,n){return t==="in"?new Pv(e,n):new Sv(e,n)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&t.nullValue===void 0&&this.matchesComparison(en(t,this.value)):t!==null&&It(this.value)===It(t)&&this.matchesComparison(en(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return Q(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class tt extends mu{constructor(e,t){super(),this.filters=e,this.op=t,this.Te=null}static create(e,t){return new tt(e,t)}matches(e){return gu(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.Te!==null||(this.Te=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.Te}getFilters(){return Object.assign([],this.filters)}}function gu(s){return s.op==="and"}function _u(s){return Av(s)&&gu(s)}function Av(s){for(const e of s.filters)if(e instanceof tt)return!1;return!0}function oi(s){if(s instanceof Te)return s.field.canonicalString()+s.op.toString()+tn(s.value);if(_u(s))return s.filters.map(e=>oi(e)).join(",");{const e=s.filters.map(t=>oi(t)).join(",");return`${s.op}(${e})`}}function vu(s,e){return s instanceof Te?function(n,r){return r instanceof Te&&n.op===r.op&&n.field.isEqual(r.field)&&et(n.value,r.value)}(s,e):s instanceof tt?function(n,r){return r instanceof tt&&n.op===r.op&&n.filters.length===r.filters.length?n.filters.reduce((o,a,u)=>o&&vu(a,r.filters[u]),!0):!1}(s,e):void Q(19439)}function yu(s){return s instanceof Te?function(t){return`${t.field.canonicalString()} ${t.op} ${tn(t.value)}`}(s):s instanceof tt?function(t){return t.op.toString()+" {"+t.getFilters().map(yu).join(" ,")+"}"}(s):"Filter"}class bv extends Te{constructor(e,t,n){super(e,t,n),this.key=G.fromName(n.referenceValue)}matches(e){const t=G.comparator(e.key,this.key);return this.matchesComparison(t)}}class Pv extends Te{constructor(e,t){super(e,"in",t),this.keys=Eu("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class Sv extends Te{constructor(e,t){super(e,"not-in",t),this.keys=Eu("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function Eu(s,e){var t;return(((t=e.arrayValue)===null||t===void 0?void 0:t.values)||[]).map(n=>G.fromName(n.referenceValue))}class Vv extends Te{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return Mi(t)&&jn(t.arrayValue,this.value)}}class Rv extends Te{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&jn(this.value.arrayValue,t)}}class kv extends Te{constructor(e,t){super(e,"not-in",t)}matches(e){if(jn(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&t.nullValue===void 0&&!jn(this.value.arrayValue,t)}}class Cv extends Te{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!Mi(t)||!t.arrayValue.values)&&t.arrayValue.values.some(n=>jn(this.value.arrayValue,n))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dv{constructor(e,t=null,n=[],r=[],o=null,a=null,u=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=r,this.limit=o,this.startAt=a,this.endAt=u,this.Ie=null}}function za(s,e=null,t=[],n=[],r=null,o=null,a=null){return new Dv(s,e,t,n,r,o,a)}function Oi(s){const e=J(s);if(e.Ie===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(n=>oi(n)).join(","),t+="|ob:",t+=e.orderBy.map(n=>function(o){return o.field.canonicalString()+o.dir}(n)).join(","),Ys(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(n=>tn(n)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(n=>tn(n)).join(",")),e.Ie=t}return e.Ie}function $i(s,e){if(s.limit!==e.limit||s.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<s.orderBy.length;t++)if(!wv(s.orderBy[t],e.orderBy[t]))return!1;if(s.filters.length!==e.filters.length)return!1;for(let t=0;t<s.filters.length;t++)if(!vu(s.filters[t],e.filters[t]))return!1;return s.collectionGroup===e.collectionGroup&&!!s.path.isEqual(e.path)&&!!qa(s.startAt,e.startAt)&&qa(s.endAt,e.endAt)}function ai(s){return G.isDocumentKey(s.path)&&s.collectionGroup===null&&s.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xv=new pe(G.comparator);function at(){return xv}const wu=new pe(G.comparator);function Rn(...s){let e=wu;for(const t of s)e=e.insert(t.key,t);return e}function Au(s){let e=wu;return s.forEach((t,n)=>e=e.insert(t,n.overlayedDocument)),e}function Nt(){return Mn()}function bu(){return Mn()}function Mn(){return new Ft(s=>s.toString(),(s,e)=>s.isEqual(e))}const Fv=new pe(G.comparator),Bv=new we(G.comparator);function re(...s){let e=Bv;for(const t of s)e=e.add(t);return e}const Uv=new we(te);function jv(){return Uv}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fi(s,e){if(s.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ms(e)?"-0":e}}function Pu(s){return{integerValue:""+s}}function Su(s,e){return mv(e)?Pu(e):Fi(s,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rs{constructor(e,t,n,r){this.De=e,this.removedTargetIds=t,this.key=n,this.ve=r}}class Ou{constructor(e,t){this.targetId=e,this.Ce=t}}class $u{constructor(e,t,n=Re.EMPTY_BYTE_STRING,r=null){this.state=e,this.targetIds=t,this.resumeToken=n,this.cause=r}}class Za{constructor(){this.Fe=0,this.Me=el(),this.xe=Re.EMPTY_BYTE_STRING,this.Oe=!1,this.Ne=!0}get current(){return this.Oe}get resumeToken(){return this.xe}get Be(){return this.Fe!==0}get Le(){return this.Ne}ke(e){e.approximateByteSize()>0&&(this.Ne=!0,this.xe=e)}qe(){let e=re(),t=re(),n=re();return this.Me.forEach((r,o)=>{switch(o){case 0:e=e.add(r);break;case 2:t=t.add(r);break;case 1:n=n.add(r);break;default:Q(38017,{changeType:o})}}),new Yn(this.xe,this.Oe,e,t,n)}Qe(){this.Ne=!1,this.Me=el()}$e(e,t){this.Ne=!0,this.Me=this.Me.insert(e,t)}Ue(e){this.Ne=!0,this.Me=this.Me.remove(e)}Ke(){this.Fe+=1}We(){this.Fe-=1,ce(this.Fe>=0,3241,{Fe:this.Fe})}Ge(){this.Ne=!0,this.Oe=!0}}class ny{constructor(e){this.ze=e,this.je=new Map,this.He=at(),this.Je=Is(),this.Ye=Is(),this.Ze=new pe(te)}Xe(e){for(const t of e.De)e.ve&&e.ve.isFoundDocument()?this.et(t,e.ve):this.tt(t,e.key,e.ve);for(const t of e.removedTargetIds)this.tt(t,e.key,e.ve)}nt(e){this.forEachTarget(e,t=>{const n=this.rt(t);switch(e.state){case 0:this.it(t)&&n.ke(e.resumeToken);break;case 1:n.We(),n.Be||n.Qe(),n.ke(e.resumeToken);break;case 2:n.We(),n.Be||this.removeTarget(t);break;case 3:this.it(t)&&(n.Ge(),n.ke(e.resumeToken));break;case 4:this.it(t)&&(this.st(t),n.ke(e.resumeToken));break;default:Q(56790,{state:e.state})}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.je.forEach((n,r)=>{this.it(r)&&t(r)})}ot(e){const t=e.targetId,n=e.Ce.count,r=this._t(t);if(r){const o=r.target;if(ai(o))if(n===0){const a=new G(o.path);this.tt(t,a,$e.newNoDocument(a,Y.min()))}else ce(n===1,20013,{expectedCount:n});else{const a=this.ut(t);if(a!==n){const u=this.ct(e),h=u?this.lt(u,e,a):1;if(h!==0){this.st(t);const d=h===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Ze=this.Ze.insert(t,d)}}}}}ct(e){const t=e.Ce.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:n="",padding:r=0},hashCount:o=0}=t;let a,u;try{a=Tt(n).toUint8Array()}catch(h){if(h instanceof au)return Jt("Decoding the base64 bloom filter in existence filter failed ("+h.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw h}try{u=new Ui(a,r,o)}catch(h){return Jt(h instanceof kn?"BloomFilter error: ":"Applying bloom filter failed: ",h),null}return u.pe===0?null:u}lt(e,t,n){return t.Ce.count===n-this.Tt(e,t.targetId)?0:2}Tt(e,t){const n=this.ze.getRemoteKeysForTarget(t);let r=0;return n.forEach(o=>{const a=this.ze.Pt(),u=`projects/${a.projectId}/databases/${a.database}/documents/${o.path.canonicalString()}`;e.mightContain(u)||(this.tt(t,o,null),r++)}),r}It(e){const t=new Map;this.je.forEach((o,a)=>{const u=this._t(a);if(u){if(o.current&&ai(u.target)){const h=new G(u.target.path);this.Et(h).has(a)||this.dt(a,h)||this.tt(a,h,$e.newNoDocument(h,e))}o.Le&&(t.set(a,o.qe()),o.Qe())}});let n=re();this.Ye.forEach((o,a)=>{let u=!0;a.forEachWhile(h=>{const d=this._t(h);return!d||d.purpose==="TargetPurposeLimboResolution"||(u=!1,!1)}),u&&(n=n.add(o))}),this.He.forEach((o,a)=>a.setReadTime(e));const r=new rr(e,t,this.Ze,this.He,n);return this.He=at(),this.Je=Is(),this.Ye=Is(),this.Ze=new pe(te),r}et(e,t){if(!this.it(e))return;const n=this.dt(e,t.key)?2:0;this.rt(e).$e(t.key,n),this.He=this.He.insert(t.key,t),this.Je=this.Je.insert(t.key,this.Et(t.key).add(e)),this.Ye=this.Ye.insert(t.key,this.At(t.key).add(e))}tt(e,t,n){if(!this.it(e))return;const r=this.rt(e);this.dt(e,t)?r.$e(t,1):r.Ue(t),this.Ye=this.Ye.insert(t,this.At(t).delete(e)),this.Ye=this.Ye.insert(t,this.At(t).add(e)),n&&(this.He=this.He.insert(t,n))}removeTarget(e){this.je.delete(e)}ut(e){const t=this.rt(e).qe();return this.ze.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}Ke(e){this.rt(e).Ke()}rt(e){let t=this.je.get(e);return t||(t=new Za,this.je.set(e,t)),t}At(e){let t=this.Ye.get(e);return t||(t=new we(te),this.Ye=this.Ye.insert(e,t)),t}Et(e){let t=this.Je.get(e);return t||(t=new we(te),this.Je=this.Je.insert(e,t)),t}it(e){const t=this._t(e)!==null;return t||F("WatchChangeAggregator","Detected inactive target",e),t}_t(e){const t=this.je.get(e);return t&&t.Be?null:this.ze.Rt(e)}st(e){this.je.set(e,new Za),this.ze.getRemoteKeysForTarget(e).forEach(t=>{this.tt(e,t,null)})}dt(e,t){return this.ze.getRemoteKeysForTarget(e).has(t)}}function Is(){return new pe(G.comparator)}function el(){return new pe(G.comparator)}const sy={asc:"ASCENDING",desc:"DESCENDING"},ry={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},iy={and:"AND",or:"OR"};class oy{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function ui(s,e){return s.useProto3Json||Ys(e)?e:{value:e}}function Us(s,e){return s.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function xu(s,e){return s.useProto3Json?e.toBase64():e.toUint8Array()}function ay(s,e){return Us(s,e.toTimestamp())}function Ze(s){return ce(!!s,49232),Y.fromTimestamp(function(t){const n=Et(t);return new Ie(n.seconds,n.nanos)}(s))}function ji(s,e){return ci(s,e).canonicalString()}function ci(s,e){const t=function(r){return new ge(["projects",r.projectId,"databases",r.database])}(s).child("documents");return e===void 0?t:t.child(e)}function Fu(s){const e=ge.fromString(s);return ce(qu(e),10190,{key:e.toString()}),e}function hi(s,e){return ji(s.databaseId,e.path)}function jr(s,e){const t=Fu(e);if(t.get(1)!==s.databaseId.projectId)throw new z(O.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+s.databaseId.projectId);if(t.get(3)!==s.databaseId.database)throw new z(O.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+s.databaseId.database);return new G(Uu(t))}function Bu(s,e){return ji(s.databaseId,e)}function ly(s){const e=Fu(s);return e.length===4?ge.emptyPath():Uu(e)}function di(s){return new ge(["projects",s.databaseId.projectId,"databases",s.databaseId.database]).canonicalString()}function Uu(s){return ce(s.length>4&&s.get(4)==="documents",29091,{key:s.toString()}),s.popFirst(5)}function tl(s,e,t){return{name:hi(s,e),fields:t.value.mapValue.fields}}function uy(s,e){let t;if("targetChange"in e){e.targetChange;const n=function(d){return d==="NO_CHANGE"?0:d==="ADD"?1:d==="REMOVE"?2:d==="CURRENT"?3:d==="RESET"?4:Q(39313,{state:d})}(e.targetChange.targetChangeType||"NO_CHANGE"),r=e.targetChange.targetIds||[],o=function(d,p){return d.useProto3Json?(ce(p===void 0||typeof p=="string",58123),Re.fromBase64String(p||"")):(ce(p===void 0||p instanceof Buffer||p instanceof Uint8Array,16193),Re.fromUint8Array(p||new Uint8Array))}(s,e.targetChange.resumeToken),a=e.targetChange.cause,u=a&&function(d){const p=d.code===void 0?O.UNKNOWN:Mu(d.code);return new z(p,d.message||"")}(a);t=new $u(n,r,o,u||null)}else if("documentChange"in e){e.documentChange;const n=e.documentChange;n.document,n.document.name,n.document.updateTime;const r=jr(s,n.document.name),o=Ze(n.document.updateTime),a=n.document.createTime?Ze(n.document.createTime):Y.min(),u=new Ue({mapValue:{fields:n.document.fields}}),h=$e.newFoundDocument(r,o,a,u),d=n.targetIds||[],p=n.removedTargetIds||[];t=new Rs(d,p,h.key,h)}else if("documentDelete"in e){e.documentDelete;const n=e.documentDelete;n.document;const r=jr(s,n.document),o=n.readTime?Ze(n.readTime):Y.min(),a=$e.newNoDocument(r,o),u=n.removedTargetIds||[];t=new Rs([],u,a.key,a)}else if("documentRemove"in e){e.documentRemove;const n=e.documentRemove;n.document;const r=jr(s,n.document),o=n.removedTargetIds||[];t=new Rs([],o,r,null)}else{if(!("filter"in e))return Q(11601,{Vt:e});{e.filter;const n=e.filter;n.targetId;const{count:r=0,unchangedNames:o}=n,a=new Zv(r,o),u=n.targetId;t=new Ou(u,a)}}return t}function cy(s,e){let t;if(e instanceof Xn)t={update:tl(s,e.key,e.value)};else if(e instanceof Lu)t={delete:hi(s,e.key)};else if(e instanceof St)t={update:tl(s,e.key,e.data),updateMask:yy(e.fieldMask)};else{if(!(e instanceof Xv))return Q(16599,{ft:e.type});t={verify:hi(s,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(n=>function(o,a){const u=a.transform;if(u instanceof Bs)return{fieldPath:a.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(u instanceof Hn)return{fieldPath:a.field.canonicalString(),appendMissingElements:{values:u.elements}};if(u instanceof qn)return{fieldPath:a.field.canonicalString(),removeAllFromArray:{values:u.elements}};if(u instanceof zn)return{fieldPath:a.field.canonicalString(),increment:u.Re};throw Q(20930,{transform:a.transform})}(0,n))),e.precondition.isNone||(t.currentDocument=function(r,o){return o.updateTime!==void 0?{updateTime:ay(r,o.updateTime)}:o.exists!==void 0?{exists:o.exists}:Q(27497)}(s,e.precondition)),t}function hy(s,e){return s&&s.length>0?(ce(e!==void 0,14353),s.map(t=>function(r,o){let a=r.updateTime?Ze(r.updateTime):Ze(o);return a.isEqual(Y.min())&&(a=Ze(o)),new Kv(a,r.transformResults||[])}(t,e))):[]}function dy(s,e){return{documents:[Bu(s,e.path)]}}function fy(s,e){const t={structuredQuery:{}},n=e.path;let r;e.collectionGroup!==null?(r=n,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(r=n.popLast(),t.structuredQuery.from=[{collectionId:n.lastSegment()}]),t.parent=Bu(s,r);const o=function(d){if(d.length!==0)return Hu(tt.create(d,"and"))}(e.filters);o&&(t.structuredQuery.where=o);const a=function(d){if(d.length!==0)return d.map(p=>function(y){return{field:Kt(y.field),direction:gy(y.dir)}}(p))}(e.orderBy);a&&(t.structuredQuery.orderBy=a);const u=ui(s,e.limit);return u!==null&&(t.structuredQuery.limit=u),e.startAt&&(t.structuredQuery.startAt=function(d){return{before:d.inclusive,values:d.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(d){return{before:!d.inclusive,values:d.position}}(e.endAt)),{gt:t,parent:r}}function py(s){let e=ly(s.parent);const t=s.structuredQuery,n=t.from?t.from.length:0;let r=null;if(n>0){ce(n===1,65062);const p=t.from[0];p.allDescendants?r=p.collectionId:e=e.child(p.collectionId)}let o=[];t.where&&(o=function(_){const y=ju(_);return y instanceof tt&&_u(y)?y.getFilters():[y]}(t.where));let a=[];t.orderBy&&(a=function(_){return _.map(y=>function(M){return new Fs(Wt(M.field),function(N){switch(N){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(M.direction))}(y))}(t.orderBy));let u=null;t.limit&&(u=function(_){let y;return y=typeof _=="object"?_.value:_,Ys(y)?null:y}(t.limit));let h=null;t.startAt&&(h=function(_){const y=!!_.before,S=_.values||[];return new xs(S,y)}(t.startAt));let d=null;return t.endAt&&(d=function(_){const y=!_.before,S=_.values||[];return new xs(S,y)}(t.endAt)),Nv(e,r,a,o,u,"F",h,d)}function my(s,e){const t=function(r){switch(r){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return Q(28987,{purpose:r})}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function ju(s){return s.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const n=Wt(t.unaryFilter.field);return Te.create(n,"==",{doubleValue:NaN});case"IS_NULL":const r=Wt(t.unaryFilter.field);return Te.create(r,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const o=Wt(t.unaryFilter.field);return Te.create(o,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const a=Wt(t.unaryFilter.field);return Te.create(a,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return Q(61313);default:return Q(60726)}}(s):s.fieldFilter!==void 0?function(t){return Te.create(Wt(t.fieldFilter.field),function(r){switch(r){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return Q(58110);default:return Q(50506)}}(t.fieldFilter.op),t.fieldFilter.value)}(s):s.compositeFilter!==void 0?function(t){return tt.create(t.compositeFilter.filters.map(n=>ju(n)),function(r){switch(r){case"AND":return"and";case"OR":return"or";default:return Q(1026)}}(t.compositeFilter.op))}(s):Q(30097,{filter:s})}function gy(s){return sy[s]}function _y(s){return ry[s]}function vy(s){return iy[s]}function Kt(s){return{fieldPath:s.canonicalString()}}function Wt(s){return Se.fromServerFormat(s.fieldPath)}function Hu(s){return s instanceof Te?function(t){if(t.op==="=="){if(ja(t.value))return{unaryFilter:{field:Kt(t.field),op:"IS_NAN"}};if(Ua(t.value))return{unaryFilter:{field:Kt(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(ja(t.value))return{unaryFilter:{field:Kt(t.field),op:"IS_NOT_NAN"}};if(Ua(t.value))return{unaryFilter:{field:Kt(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:Kt(t.field),op:_y(t.op),value:t.value}}}(s):s instanceof tt?function(t){const n=t.getFilters().map(r=>Hu(r));return n.length===1?n[0]:{compositeFilter:{op:vy(t.op),filters:n}}}(s):Q(54877,{filter:s})}function yy(s){const e=[];return s.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function qu(s){return s.length>=4&&s.get(0)==="projects"&&s.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ey{constructor(e){this.wt=e}}function Ty(s){const e=py({parent:s.parent,structuredQuery:s.structuredQuery});return s.limitType==="LAST"?li(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ry{constructor(){this.changes=new Ft(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,$e.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const n=this.changes.get(t);return n!==void 0?D.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dy{constructor(e){this.serializer=e,this.kr=new Map,this.qr=new Map}getBundleMetadata(e,t){return D.resolve(this.kr.get(t))}saveBundleMetadata(e,t){return this.kr.set(t.id,function(r){return{id:r.id,version:r.version,createTime:Ze(r.createTime)}}(t)),D.resolve()}getNamedQuery(e,t){return D.resolve(this.qr.get(t))}saveNamedQuery(e,t){return this.qr.set(t.name,function(r){return{name:r.name,query:Ty(r.bundledQuery),readTime:Ze(r.readTime)}}(t)),D.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ly{constructor(){this.sessionToken=Re.EMPTY_BYTE_STRING}getSessionToken(e){return D.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,D.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hi{constructor(){this.$r=new we(Ae.Ur),this.Kr=new we(Ae.Wr)}isEmpty(){return this.$r.isEmpty()}addReference(e,t){const n=new Ae(e,t);this.$r=this.$r.add(n),this.Kr=this.Kr.add(n)}Gr(e,t){e.forEach(n=>this.addReference(n,t))}removeReference(e,t){this.zr(new Ae(e,t))}jr(e,t){e.forEach(n=>this.removeReference(n,t))}Hr(e){const t=new G(new ge([])),n=new Ae(t,e),r=new Ae(t,e+1),o=[];return this.Kr.forEachInRange([n,r],a=>{this.zr(a),o.push(a.key)}),o}Jr(){this.$r.forEach(e=>this.zr(e))}zr(e){this.$r=this.$r.delete(e),this.Kr=this.Kr.delete(e)}Yr(e){const t=new G(new ge([])),n=new Ae(t,e),r=new Ae(t,e+1);let o=re();return this.Kr.forEachInRange([n,r],a=>{o=o.add(a.key)}),o}containsKey(e){const t=new Ae(e,0),n=this.$r.firstAfterOrEqual(t);return n!==null&&e.isEqual(n.key)}}class Ae{constructor(e,t){this.key=e,this.Zr=t}static Ur(e,t){return G.comparator(e.key,t.key)||te(e.Zr,t.Zr)}static Wr(e,t){return te(e.Zr,t.Zr)||G.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class My{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.nr=1,this.Xr=new we(Ae.Ur)}checkEmpty(e){return D.resolve(this.mutationQueue.length===0)}addMutationBatch(e,t,n,r){const o=this.nr;this.nr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const a=new Yv(o,t,n,r);this.mutationQueue.push(a);for(const u of r)this.Xr=this.Xr.add(new Ae(u.key,o)),this.indexManager.addToCollectionParentIndex(e,u.key.path.popLast());return D.resolve(a)}lookupMutationBatch(e,t){return D.resolve(this.ei(t))}getNextMutationBatchAfterBatchId(e,t){const n=t+1,r=this.ti(n),o=r<0?0:r;return D.resolve(this.mutationQueue.length>o?this.mutationQueue[o]:null)}getHighestUnacknowledgedBatchId(){return D.resolve(this.mutationQueue.length===0?Ni:this.nr-1)}getAllMutationBatches(e){return D.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const n=new Ae(t,0),r=new Ae(t,Number.POSITIVE_INFINITY),o=[];return this.Xr.forEachInRange([n,r],a=>{const u=this.ei(a.Zr);o.push(u)}),D.resolve(o)}getAllMutationBatchesAffectingDocumentKeys(e,t){let n=new we(te);return t.forEach(r=>{const o=new Ae(r,0),a=new Ae(r,Number.POSITIVE_INFINITY);this.Xr.forEachInRange([o,a],u=>{n=n.add(u.Zr)})}),D.resolve(this.ni(n))}getAllMutationBatchesAffectingQuery(e,t){const n=t.path,r=n.length+1;let o=n;G.isDocumentKey(o)||(o=o.child(""));const a=new Ae(new G(o),0);let u=new we(te);return this.Xr.forEachWhile(h=>{const d=h.key.path;return!!n.isPrefixOf(d)&&(d.length===r&&(u=u.add(h.Zr)),!0)},a),D.resolve(this.ni(u))}ni(e){const t=[];return e.forEach(n=>{const r=this.ei(n);r!==null&&t.push(r)}),t}removeMutationBatch(e,t){ce(this.ri(t.batchId,"removed")===0,55003),this.mutationQueue.shift();let n=this.Xr;return D.forEach(t.mutations,r=>{const o=new Ae(r.key,t.batchId);return n=n.delete(o),this.referenceDelegate.markPotentiallyOrphaned(e,r.key)}).next(()=>{this.Xr=n})}sr(e){}containsKey(e,t){const n=new Ae(t,0),r=this.Xr.firstAfterOrEqual(n);return D.resolve(t.isEqual(r&&r.key))}performConsistencyCheck(e){return this.mutationQueue.length,D.resolve()}ri(e,t){return this.ti(e)}ti(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}ei(e){const t=this.ti(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gi="LocalStore",jy=3e8;class Hy{constructor(e,t,n,r){this.persistence=e,this.Ms=t,this.serializer=r,this.xs=new pe(te),this.Os=new Ft(o=>Oi(o),$i),this.Ns=new Map,this.Bs=e.getRemoteDocumentCache(),this.Ti=e.getTargetCache(),this.Ei=e.getBundleCache(),this.Ls(n)}Ls(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new Cy(this.Bs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Bs.setIndexManager(this.indexManager),this.Ms.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",t=>e.collect(t,this.xs))}}function qy(s,e,t,n){return new Hy(s,e,t,n)}async function Ku(s,e){const t=J(s);return await t.persistence.runTransaction("Handle user change","readonly",n=>{let r;return t.mutationQueue.getAllMutationBatches(n).next(o=>(r=o,t.Ls(e),t.mutationQueue.getAllMutationBatches(n))).next(o=>{const a=[],u=[];let h=re();for(const d of r){a.push(d.batchId);for(const p of d.mutations)h=h.add(p.key)}for(const d of o){u.push(d.batchId);for(const p of d.mutations)h=h.add(p.key)}return t.localDocuments.getDocuments(n,h).next(d=>({ks:d,removedBatchIds:a,addedBatchIds:u}))})})}function zy(s,e){const t=J(s);return t.persistence.runTransaction("Acknowledge batch","readwrite-primary",n=>{const r=e.batch.keys(),o=t.Bs.newChangeBuffer({trackRemovals:!0});return function(u,h,d,p){const _=d.batch,y=_.keys();let S=D.resolve();return y.forEach(M=>{S=S.next(()=>p.getEntry(h,M)).next(x=>{const N=d.docVersions.get(M);ce(N!==null,48541),x.version.compareTo(N)<0&&(_.applyToRemoteDocument(x,d),x.isValidDocument()&&(x.setReadTime(d.commitVersion),p.addEntry(x)))})}),S.next(()=>u.mutationQueue.removeMutationBatch(h,_))}(t,n,e,o).next(()=>o.apply(n)).next(()=>t.mutationQueue.performConsistencyCheck(n)).next(()=>t.documentOverlayCache.removeOverlaysForBatchId(n,r,e.batch.batchId)).next(()=>t.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(n,function(u){let h=re();for(let d=0;d<u.mutationResults.length;++d)u.mutationResults[d].transformResults.length>0&&(h=h.add(u.batch.mutations[d].key));return h}(e))).next(()=>t.localDocuments.getDocuments(n,r))})}function Wu(s){const e=J(s);return e.persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.Ti.getLastRemoteSnapshotVersion(t))}function Gy(s,e){const t=J(s),n=e.snapshotVersion;let r=t.xs;return t.persistence.runTransaction("Apply remote event","readwrite-primary",o=>{const a=t.Bs.newChangeBuffer({trackRemovals:!0});r=t.xs;const u=[];e.targetChanges.forEach((p,_)=>{const y=r.get(_);if(!y)return;u.push(t.Ti.removeMatchingKeys(o,p.removedDocuments,_).next(()=>t.Ti.addMatchingKeys(o,p.addedDocuments,_)));let S=y.withSequenceNumber(o.currentSequenceNumber);e.targetMismatches.get(_)!==null?S=S.withResumeToken(Re.EMPTY_BYTE_STRING,Y.min()).withLastLimboFreeSnapshotVersion(Y.min()):p.resumeToken.approximateByteSize()>0&&(S=S.withResumeToken(p.resumeToken,n)),r=r.insert(_,S),function(x,N,X){return x.resumeToken.approximateByteSize()===0||N.snapshotVersion.toMicroseconds()-x.snapshotVersion.toMicroseconds()>=jy?!0:X.addedDocuments.size+X.modifiedDocuments.size+X.removedDocuments.size>0}(y,S,p)&&u.push(t.Ti.updateTargetData(o,S))});let h=at(),d=re();if(e.documentUpdates.forEach(p=>{e.resolvedLimboDocuments.has(p)&&u.push(t.persistence.referenceDelegate.updateLimboDocument(o,p))}),u.push(Ky(o,a,e.documentUpdates).next(p=>{h=p.qs,d=p.Qs})),!n.isEqual(Y.min())){const p=t.Ti.getLastRemoteSnapshotVersion(o).next(_=>t.Ti.setTargetsMetadata(o,o.currentSequenceNumber,n));u.push(p)}return D.waitFor(u).next(()=>a.apply(o)).next(()=>t.localDocuments.getLocalViewOfDocuments(o,h,d)).next(()=>h)}).then(o=>(t.xs=r,o))}function Ky(s,e,t){let n=re(),r=re();return t.forEach(o=>n=n.add(o)),e.getEntries(s,n).next(o=>{let a=at();return t.forEach((u,h)=>{const d=o.get(u);h.isFoundDocument()!==d.isFoundDocument()&&(r=r.add(u)),h.isNoDocument()&&h.version.isEqual(Y.min())?(e.removeEntry(u,h.readTime),a=a.insert(u,h)):!d.isValidDocument()||h.version.compareTo(d.version)>0||h.version.compareTo(d.version)===0&&d.hasPendingWrites?(e.addEntry(h),a=a.insert(u,h)):F(Gi,"Ignoring outdated watch update for ",u,". Current version:",d.version," Watch version:",h.version)}),{qs:a,Qs:r}})}function Wy(s,e){const t=J(s);return t.persistence.runTransaction("Get next mutation batch","readonly",n=>(e===void 0&&(e=Ni),t.mutationQueue.getNextMutationBatchAfterBatchId(n,e)))}function Qy(s,e){const t=J(s);return t.persistence.runTransaction("Allocate target","readwrite",n=>{let r;return t.Ti.getTargetData(n,e).next(o=>o?(r=o,D.resolve(r)):t.Ti.allocateTargetId(n).next(a=>(r=new ft(e,a,"TargetPurposeListen",n.currentSequenceNumber),t.Ti.addTargetData(n,r).next(()=>r))))}).then(n=>{const r=t.xs.get(n.targetId);return(r===null||n.snapshotVersion.compareTo(r.snapshotVersion)>0)&&(t.xs=t.xs.insert(n.targetId,n),t.Os.set(e,n.targetId)),n})}async function fi(s,e,t){const n=J(s),r=n.xs.get(e),o=t?"readwrite":"readwrite-primary";try{t||await n.persistence.runTransaction("Release target",o,a=>n.persistence.referenceDelegate.removeTarget(a,r))}catch(a){if(!un(a))throw a;F(Gi,`Failed to update sequence numbers for target ${e}: ${a}`)}n.xs=n.xs.remove(e),n.Os.delete(r.target)}function il(s,e,t){const n=J(s);let r=Y.min(),o=re();return n.persistence.runTransaction("Execute query","readwrite",a=>function(h,d,p){const _=J(h),y=_.Os.get(p);return y!==void 0?D.resolve(_.xs.get(y)):_.Ti.getTargetData(d,p)}(n,a,Ye(e)).next(u=>{if(u)return r=u.lastLimboFreeSnapshotVersion,n.Ti.getMatchingKeysForTargetId(a,u.targetId).next(h=>{o=h})}).next(()=>n.Ms.getDocumentsMatchingQuery(a,e,t?r:Y.min(),t?o:re())).next(u=>(Xy(n,Ov(e),u),{documents:u,$s:o})))}function Xy(s,e,t){let n=s.Ns.get(e)||Y.min();t.forEach((r,o)=>{o.readTime.compareTo(n)>0&&(n=o.readTime)}),s.Ns.set(e,n)}class ol{constructor(){this.activeTargetIds=jv()}js(e){this.activeTargetIds=this.activeTargetIds.add(e)}Hs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}zs(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class Yy{constructor(){this.xo=new ol,this.Oo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,n){}addLocalQueryTarget(e,t=!0){return t&&this.xo.js(e),this.Oo[e]||"not-current"}updateQueryState(e,t,n){this.Oo[e]=t}removeLocalQueryTarget(e){this.xo.Hs(e)}isLocalQueryTarget(e){return this.xo.activeTargetIds.has(e)}clearQueryState(e){delete this.Oo[e]}getAllActiveQueryTargets(){return this.xo.activeTargetIds}isActiveQueryTarget(e){return this.xo.activeTargetIds.has(e)}start(){return this.xo=new ol,Promise.resolve()}handleUserChange(e,t,n){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hr="RestConnection",Zy={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class eE{get Uo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),r=encodeURIComponent(this.databaseId.database);this.Ko=t+"://"+e.host,this.Wo=`projects/${n}/databases/${r}`,this.Go=this.databaseId.database===Os?`project_id=${n}`:`project_id=${n}&database_id=${r}`}zo(e,t,n,r,o){const a=pi(),u=this.jo(e,t.toUriEncodedString());F(Hr,`Sending RPC '${e}' ${a}:`,u,n);const h={"google-cloud-resource-prefix":this.Wo,"x-goog-request-params":this.Go};this.Ho(h,r,o);const{host:d}=new URL(u),p=ki(d);return this.Jo(e,u,h,n,p).then(_=>(F(Hr,`Received RPC '${e}' ${a}: `,_),_),_=>{throw Jt(Hr,`RPC '${e}' ${a} failed with error: `,_,"url: ",u,"request:",n),_})}Yo(e,t,n,r,o,a){return this.zo(e,t,n,r,o)}Ho(e,t,n){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+an}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((r,o)=>e[o]=r),n&&n.headers.forEach((r,o)=>e[o]=r)}jo(e,t){const n=Zy[e];return`${this.Ko}/v1/${t}:${n}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tE{constructor(e){this.Zo=e.Zo,this.Xo=e.Xo}e_(e){this.t_=e}n_(e){this.r_=e}i_(e){this.s_=e}onMessage(e){this.o_=e}close(){this.Xo()}send(e){this.Zo(e)}__(){this.t_()}a_(){this.r_()}u_(e){this.s_(e)}c_(e){this.o_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Me="WebChannelConnection";class nE extends eE{constructor(e){super(e),this.l_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,n,r,o){const a=pi();return new Promise((u,h)=>{const d=new Xl;d.setWithCredentials(!0),d.listenOnce(Yl.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case bs.NO_ERROR:const _=d.getResponseJson();F(Me,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(_)),u(_);break;case bs.TIMEOUT:F(Me,`RPC '${e}' ${a} timed out`),h(new z(O.DEADLINE_EXCEEDED,"Request time out"));break;case bs.HTTP_ERROR:const y=d.getStatus();if(F(Me,`RPC '${e}' ${a} failed with status:`,y,"response text:",d.getResponseText()),y>0){let S=d.getResponseJson();Array.isArray(S)&&(S=S[0]);const M=S==null?void 0:S.error;if(M&&M.status&&M.message){const x=function(X){const K=X.toLowerCase().replace(/_/g,"-");return Object.values(O).indexOf(K)>=0?K:O.UNKNOWN}(M.status);h(new z(x,M.message))}else h(new z(O.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new z(O.UNAVAILABLE,"Connection failed."));break;default:Q(9055,{h_:e,streamId:a,P_:d.getLastErrorCode(),T_:d.getLastError()})}}finally{F(Me,`RPC '${e}' ${a} completed.`)}});const p=JSON.stringify(r);F(Me,`RPC '${e}' ${a} sending request:`,r),d.send(t,"POST",p,n,15)})}I_(e,t,n){const r=pi(),o=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=eu(),u=Zl(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Ho(h.initMessageHeaders,t,n),h.encodeInitMessageHeaders=!0;const p=o.join("");F(Me,`Creating RPC '${e}' stream ${r}: ${p}`,h);const _=a.createWebChannel(p,h);this.E_(_);let y=!1,S=!1;const M=new tE({Zo:N=>{S?F(Me,`Not sending because RPC '${e}' stream ${r} is closed:`,N):(y||(F(Me,`Opening RPC '${e}' stream ${r} transport.`),_.open(),y=!0),F(Me,`RPC '${e}' stream ${r} sending:`,N),_.send(N))},Xo:()=>_.close()}),x=(N,X,K)=>{N.listen(X,ee=>{try{K(ee)}catch(he){setTimeout(()=>{throw he},0)}})};return x(_,Vn.EventType.OPEN,()=>{S||(F(Me,`RPC '${e}' stream ${r} transport opened.`),M.__())}),x(_,Vn.EventType.CLOSE,()=>{S||(S=!0,F(Me,`RPC '${e}' stream ${r} transport closed`),M.u_(),this.d_(_))}),x(_,Vn.EventType.ERROR,N=>{S||(S=!0,Jt(Me,`RPC '${e}' stream ${r} transport errored. Name:`,N.name,"Message:",N.message),M.u_(new z(O.UNAVAILABLE,"The operation could not be completed")))}),x(_,Vn.EventType.MESSAGE,N=>{var X;if(!S){const K=N.data[0];ce(!!K,16349);const ee=K,he=(ee==null?void 0:ee.error)||((X=ee[0])===null||X===void 0?void 0:X.error);if(he){F(Me,`RPC '${e}' stream ${r} received error:`,he);const ke=he.status;let ye=function(v){const E=Ee[v];if(E!==void 0)return Mu(E)}(ke),w=he.message;ye===void 0&&(ye=O.INTERNAL,w="Unknown error status: "+ke+" with message "+he.message),S=!0,M.u_(new z(ye,w)),_.close()}else F(Me,`RPC '${e}' stream ${r} received:`,K),M.c_(K)}}),x(u,Jl.STAT_EVENT,N=>{N.stat===ni.PROXY?F(Me,`RPC '${e}' stream ${r} detected buffering proxy`):N.stat===ni.NOPROXY&&F(Me,`RPC '${e}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{M.a_()},0),M}terminate(){this.l_.forEach(e=>e.close()),this.l_=[]}E_(e){this.l_.push(e)}d_(e){this.l_=this.l_.filter(t=>t===e)}}function qr(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ir(s){return new oy(s,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ul="PersistentStream";class Xu{constructor(e,t,n,r,o,a,u,h){this.xi=e,this.S_=n,this.D_=r,this.connection=o,this.authCredentialsProvider=a,this.appCheckCredentialsProvider=u,this.listener=h,this.state=0,this.v_=0,this.C_=null,this.F_=null,this.stream=null,this.M_=0,this.x_=new Qu(e,t)}O_(){return this.state===1||this.state===5||this.N_()}N_(){return this.state===2||this.state===3}start(){this.M_=0,this.state!==4?this.auth():this.B_()}async stop(){this.O_()&&await this.close(0)}L_(){this.state=0,this.x_.reset()}k_(){this.N_()&&this.C_===null&&(this.C_=this.xi.enqueueAfterDelay(this.S_,6e4,()=>this.q_()))}Q_(e){this.U_(),this.stream.send(e)}async q_(){if(this.N_())return this.close(0)}U_(){this.C_&&(this.C_.cancel(),this.C_=null)}K_(){this.F_&&(this.F_.cancel(),this.F_=null)}async close(e,t){this.U_(),this.K_(),this.x_.cancel(),this.v_++,e!==4?this.x_.reset():t&&t.code===O.RESOURCE_EXHAUSTED?(ot(t.toString()),ot("Using maximum backoff delay to prevent overloading the backend."),this.x_.p_()):t&&t.code===O.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.W_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.i_(t)}W_(){}auth(){this.state=1;const e=this.G_(this.v_),t=this.v_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([n,r])=>{this.v_===t&&this.z_(n,r)},n=>{e(()=>{const r=new z(O.UNKNOWN,"Fetching auth token failed: "+n.message);return this.j_(r)})})}z_(e,t){const n=this.G_(this.v_);this.stream=this.H_(e,t),this.stream.e_(()=>{n(()=>this.listener.e_())}),this.stream.n_(()=>{n(()=>(this.state=2,this.F_=this.xi.enqueueAfterDelay(this.D_,1e4,()=>(this.N_()&&(this.state=3),Promise.resolve())),this.listener.n_()))}),this.stream.i_(r=>{n(()=>this.j_(r))}),this.stream.onMessage(r=>{n(()=>++this.M_==1?this.J_(r):this.onNext(r))})}B_(){this.state=5,this.x_.y_(async()=>{this.state=0,this.start()})}j_(e){return F(ul,`close with error: ${e}`),this.stream=null,this.close(4,e)}G_(e){return t=>{this.xi.enqueueAndForget(()=>this.v_===e?t():(F(ul,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class sE extends Xu{constructor(e,t,n,r,o,a){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,n,r,a),this.serializer=o}H_(e,t){return this.connection.I_("Listen",e,t)}J_(e){return this.onNext(e)}onNext(e){this.x_.reset();const t=uy(this.serializer,e),n=function(o){if(!("targetChange"in o))return Y.min();const a=o.targetChange;return a.targetIds&&a.targetIds.length?Y.min():a.readTime?Ze(a.readTime):Y.min()}(e);return this.listener.Y_(t,n)}Z_(e){const t={};t.database=di(this.serializer),t.addTarget=function(o,a){let u;const h=a.target;if(u=ai(h)?{documents:dy(o,h)}:{query:fy(o,h).gt},u.targetId=a.targetId,a.resumeToken.approximateByteSize()>0){u.resumeToken=xu(o,a.resumeToken);const d=ui(o,a.expectedCount);d!==null&&(u.expectedCount=d)}else if(a.snapshotVersion.compareTo(Y.min())>0){u.readTime=Us(o,a.snapshotVersion.toTimestamp());const d=ui(o,a.expectedCount);d!==null&&(u.expectedCount=d)}return u}(this.serializer,e);const n=my(this.serializer,e);n&&(t.labels=n),this.Q_(t)}X_(e){const t={};t.database=di(this.serializer),t.removeTarget=e,this.Q_(t)}}class rE extends Xu{constructor(e,t,n,r,o,a){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,n,r,a),this.serializer=o}get ea(){return this.M_>0}start(){this.lastStreamToken=void 0,super.start()}W_(){this.ea&&this.ta([])}H_(e,t){return this.connection.I_("Write",e,t)}J_(e){return ce(!!e.streamToken,31322),this.lastStreamToken=e.streamToken,ce(!e.writeResults||e.writeResults.length===0,55816),this.listener.na()}onNext(e){ce(!!e.streamToken,12678),this.lastStreamToken=e.streamToken,this.x_.reset();const t=hy(e.writeResults,e.commitTime),n=Ze(e.commitTime);return this.listener.ra(n,t)}ia(){const e={};e.database=di(this.serializer),this.Q_(e)}ta(e){const t={streamToken:this.lastStreamToken,writes:e.map(n=>cy(this.serializer,n))};this.Q_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $t="RemoteStore";class lE{constructor(e,t,n,r,o){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Ia=[],this.Ea=new Map,this.da=new Set,this.Aa=[],this.Ra=o,this.Ra.No(a=>{n.enqueueAndForget(async()=>{Bt(this)&&(F($t,"Restarting streams for network reachability change."),await async function(h){const d=J(h);d.da.add(4),await Jn(d),d.Va.set("Unknown"),d.da.delete(4),await or(d)}(this))})}),this.Va=new aE(n,r)}}async function or(s){if(Bt(s))for(const e of s.Aa)await e(!0)}async function Jn(s){for(const e of s.Aa)await e(!1)}function Yu(s,e){const t=J(s);t.Ea.has(e.targetId)||(t.Ea.set(e.targetId,e),Xi(t)?Qi(t):cn(t).N_()&&Wi(t,e))}function Ki(s,e){const t=J(s),n=cn(t);t.Ea.delete(e),n.N_()&&Ju(t,e),t.Ea.size===0&&(n.N_()?n.k_():Bt(t)&&t.Va.set("Unknown"))}function Wi(s,e){if(s.ma.Ke(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(Y.min())>0){const t=s.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}cn(s).Z_(e)}function Ju(s,e){s.ma.Ke(e),cn(s).X_(e)}function Qi(s){s.ma=new ny({getRemoteKeysForTarget:e=>s.remoteSyncer.getRemoteKeysForTarget(e),Rt:e=>s.Ea.get(e)||null,Pt:()=>s.datastore.serializer.databaseId}),cn(s).start(),s.Va.ca()}function Xi(s){return Bt(s)&&!cn(s).O_()&&s.Ea.size>0}function Bt(s){return J(s).da.size===0}function Zu(s){s.ma=void 0}async function uE(s){s.Va.set("Online")}async function cE(s){s.Ea.forEach((e,t)=>{Wi(s,e)})}async function hE(s,e){Zu(s),Xi(s)?(s.Va.Pa(e),Qi(s)):s.Va.set("Unknown")}async function dE(s,e,t){if(s.Va.set("Online"),e instanceof $u&&e.state===2&&e.cause)try{await async function(r,o){const a=o.cause;for(const u of o.targetIds)r.Ea.has(u)&&(await r.remoteSyncer.rejectListen(u,a),r.Ea.delete(u),r.ma.removeTarget(u))}(s,e)}catch(n){F($t,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await Hs(s,n)}else if(e instanceof Rs?s.ma.Xe(e):e instanceof Ou?s.ma.ot(e):s.ma.nt(e),!t.isEqual(Y.min()))try{const n=await Wu(s.localStore);t.compareTo(n)>=0&&await function(o,a){const u=o.ma.It(a);return u.targetChanges.forEach((h,d)=>{if(h.resumeToken.approximateByteSize()>0){const p=o.Ea.get(d);p&&o.Ea.set(d,p.withResumeToken(h.resumeToken,a))}}),u.targetMismatches.forEach((h,d)=>{const p=o.Ea.get(h);if(!p)return;o.Ea.set(h,p.withResumeToken(Re.EMPTY_BYTE_STRING,p.snapshotVersion)),Ju(o,h);const _=new ft(p.target,h,d,p.sequenceNumber);Wi(o,_)}),o.remoteSyncer.applyRemoteEvent(u)}(s,t)}catch(n){F($t,"Failed to raise snapshot:",n),await Hs(s,n)}}async function Hs(s,e,t){if(!un(e))throw e;s.da.add(1),await Jn(s),s.Va.set("Offline"),t||(t=()=>Wu(s.localStore)),s.asyncQueue.enqueueRetryable(async()=>{F($t,"Retrying IndexedDB access"),await t(),s.da.delete(1),await or(s)})}function ec(s,e){return e().catch(t=>Hs(s,t,e))}async function ar(s){const e=J(s),t=wt(e);let n=e.Ia.length>0?e.Ia[e.Ia.length-1].batchId:Ni;for(;fE(e);)try{const r=await Wy(e.localStore,n);if(r===null){e.Ia.length===0&&t.k_();break}n=r.batchId,pE(e,r)}catch(r){await Hs(e,r)}tc(e)&&nc(e)}function fE(s){return Bt(s)&&s.Ia.length<10}function pE(s,e){s.Ia.push(e);const t=wt(s);t.N_()&&t.ea&&t.ta(e.mutations)}function tc(s){return Bt(s)&&!wt(s).O_()&&s.Ia.length>0}function nc(s){wt(s).start()}async function mE(s){wt(s).ia()}async function gE(s){const e=wt(s);for(const t of s.Ia)e.ta(t.mutations)}async function _E(s,e,t){const n=s.Ia.shift(),r=Bi.from(n,e,t);await ec(s,()=>s.remoteSyncer.applySuccessfulWrite(r)),await ar(s)}async function vE(s,e){e&&wt(s).ea&&await async function(n,r){if(function(a){return ey(a)&&a!==O.ABORTED}(r.code)){const o=n.Ia.shift();wt(n).L_(),await ec(n,()=>n.remoteSyncer.rejectFailedWrite(o.batchId,r)),await ar(n)}}(s,e),tc(s)&&nc(s)}async function cl(s,e){const t=J(s);t.asyncQueue.verifyOperationInProgress(),F($t,"RemoteStore received new credentials");const n=Bt(t);t.da.add(3),await Jn(t),n&&t.Va.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.da.delete(3),await or(t)}async function yE(s,e){const t=J(s);e?(t.da.delete(2),await or(t)):e||(t.da.add(2),await Jn(t),t.Va.set("Unknown"))}function cn(s){return s.fa||(s.fa=function(t,n,r){const o=J(t);return o.oa(),new sE(n,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,r)}(s.datastore,s.asyncQueue,{e_:uE.bind(null,s),n_:cE.bind(null,s),i_:hE.bind(null,s),Y_:dE.bind(null,s)}),s.Aa.push(async e=>{e?(s.fa.L_(),Xi(s)?Qi(s):s.Va.set("Unknown")):(await s.fa.stop(),Zu(s))})),s.fa}function wt(s){return s.ga||(s.ga=function(t,n,r){const o=J(t);return o.oa(),new rE(n,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,r)}(s.datastore,s.asyncQueue,{e_:()=>Promise.resolve(),n_:mE.bind(null,s),i_:vE.bind(null,s),na:gE.bind(null,s),ra:_E.bind(null,s)}),s.Aa.push(async e=>{e?(s.ga.L_(),await ar(s)):(await s.ga.stop(),s.Ia.length>0&&(F($t,`Stopping write stream with ${s.Ia.length} pending writes`),s.Ia=[]))})),s.ga}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class EE{constructor(){this.ba=void 0,this.Sa=[]}Da(){return this.Sa.some(e=>e.va())}}class TE{constructor(){this.queries=dl(),this.onlineState="Unknown",this.Ca=new Set}terminate(){(function(t,n){const r=J(t),o=r.queries;r.queries=dl(),o.forEach((a,u)=>{for(const h of u.Sa)h.onError(n)})})(this,new z(O.ABORTED,"Firestore shutting down"))}}function dl(){return new Ft(s=>Tu(s),er)}async function IE(s,e){const t=J(s);let n=3;const r=e.query;let o=t.queries.get(r);o?!o.Da()&&e.va()&&(n=2):(o=new EE,n=e.va()?0:1);try{switch(n){case 0:o.ba=await t.onListen(r,!0);break;case 1:o.ba=await t.onListen(r,!1);break;case 2:await t.onFirstRemoteStoreListen(r)}}catch(a){const u=Ji(a,`Initialization of query '${Gt(e.query)}' failed`);return void e.onError(u)}t.queries.set(r,o),o.Sa.push(e),e.Fa(t.onlineState),o.ba&&e.Ma(o.ba)&&Zi(t)}async function wE(s,e){const t=J(s),n=e.query;let r=3;const o=t.queries.get(n);if(o){const a=o.Sa.indexOf(e);a>=0&&(o.Sa.splice(a,1),o.Sa.length===0?r=e.va()?0:1:!o.Da()&&e.va()&&(r=2))}switch(r){case 0:return t.queries.delete(n),t.onUnlisten(n,!0);case 1:return t.queries.delete(n),t.onUnlisten(n,!1);case 2:return t.onLastRemoteStoreUnlisten(n);default:return}}function AE(s,e){const t=J(s);let n=!1;for(const r of e){const o=r.query,a=t.queries.get(o);if(a){for(const u of a.Sa)u.Ma(r)&&(n=!0);a.ba=r}}n&&Zi(t)}function bE(s,e,t){const n=J(s),r=n.queries.get(e);if(r)for(const o of r.Sa)o.onError(t);n.queries.delete(e)}function Zi(s){s.Ca.forEach(e=>{e.next()})}var mi,fl;(fl=mi||(mi={})).xa="default",fl.Cache="cache";class PE{constructor(e,t,n){this.query=e,this.Oa=t,this.Na=!1,this.Ba=null,this.onlineState="Unknown",this.options=n||{}}Ma(e){if(!this.options.includeMetadataChanges){const n=[];for(const r of e.docChanges)r.type!==3&&n.push(r);e=new sn(e.query,e.docs,e.oldDocs,n,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.Na?this.La(e)&&(this.Oa.next(e),t=!0):this.ka(e,this.onlineState)&&(this.qa(e),t=!0),this.Ba=e,t}onError(e){this.Oa.error(e)}Fa(e){this.onlineState=e;let t=!1;return this.Ba&&!this.Na&&this.ka(this.Ba,e)&&(this.qa(this.Ba),t=!0),t}ka(e,t){if(!e.fromCache||!this.va())return!0;const n=t!=="Offline";return(!this.options.Qa||!n)&&(!e.docs.isEmpty()||e.hasCachedResults||t==="Offline")}La(e){if(e.docChanges.length>0)return!0;const t=this.Ba&&this.Ba.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&this.options.includeMetadataChanges===!0}qa(e){e=sn.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.Na=!0,this.Oa.next(e)}va(){return this.options.source!==mi.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sc{constructor(e){this.key=e}}class rc{constructor(e){this.key=e}}class SE{constructor(e,t){this.query=e,this.Ha=t,this.Ja=null,this.hasCachedResults=!1,this.current=!1,this.Ya=re(),this.mutatedKeys=re(),this.Za=Iu(e),this.Xa=new Yt(this.Za)}get eu(){return this.Ha}tu(e,t){const n=t?t.nu:new hl,r=t?t.Xa:this.Xa;let o=t?t.mutatedKeys:this.mutatedKeys,a=r,u=!1;const h=this.query.limitType==="F"&&r.size===this.query.limit?r.last():null,d=this.query.limitType==="L"&&r.size===this.query.limit?r.first():null;if(e.inorderTraversal((p,_)=>{const y=r.get(p),S=tr(this.query,_)?_:null,M=!!y&&this.mutatedKeys.has(y.key),x=!!S&&(S.hasLocalMutations||this.mutatedKeys.has(S.key)&&S.hasCommittedMutations);let N=!1;y&&S?y.data.isEqual(S.data)?M!==x&&(n.track({type:3,doc:S}),N=!0):this.ru(y,S)||(n.track({type:2,doc:S}),N=!0,(h&&this.Za(S,h)>0||d&&this.Za(S,d)<0)&&(u=!0)):!y&&S?(n.track({type:0,doc:S}),N=!0):y&&!S&&(n.track({type:1,doc:y}),N=!0,(h||d)&&(u=!0)),N&&(S?(a=a.add(S),o=x?o.add(p):o.delete(p)):(a=a.delete(p),o=o.delete(p)))}),this.query.limit!==null)for(;a.size>this.query.limit;){const p=this.query.limitType==="F"?a.last():a.first();a=a.delete(p.key),o=o.delete(p.key),n.track({type:1,doc:p})}return{Xa:a,nu:n,Cs:u,mutatedKeys:o}}ru(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,n,r){const o=this.Xa;this.Xa=e.Xa,this.mutatedKeys=e.mutatedKeys;const a=e.nu.wa();a.sort((p,_)=>function(S,M){const x=N=>{switch(N){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return Q(20277,{Vt:N})}};return x(S)-x(M)}(p.type,_.type)||this.Za(p.doc,_.doc)),this.iu(n),r=r!=null&&r;const u=t&&!r?this.su():[],h=this.Ya.size===0&&this.current&&!r?1:0,d=h!==this.Ja;return this.Ja=h,a.length!==0||d?{snapshot:new sn(this.query,e.Xa,o,a,e.mutatedKeys,h===0,d,!1,!!n&&n.resumeToken.approximateByteSize()>0),ou:u}:{ou:u}}Fa(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({Xa:this.Xa,nu:new hl,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{ou:[]}}_u(e){return!this.Ha.has(e)&&!!this.Xa.has(e)&&!this.Xa.get(e).hasLocalMutations}iu(e){e&&(e.addedDocuments.forEach(t=>this.Ha=this.Ha.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.Ha=this.Ha.delete(t)),this.current=e.current)}su(){if(!this.current)return[];const e=this.Ya;this.Ya=re(),this.Xa.forEach(n=>{this._u(n.key)&&(this.Ya=this.Ya.add(n.key))});const t=[];return e.forEach(n=>{this.Ya.has(n)||t.push(new rc(n))}),this.Ya.forEach(n=>{e.has(n)||t.push(new sc(n))}),t}au(e){this.Ha=e.$s,this.Ya=re();const t=this.tu(e.documents);return this.applyChanges(t,!0)}uu(){return sn.fromInitialDocuments(this.query,this.Xa,this.mutatedKeys,this.Ja===0,this.hasCachedResults)}}const eo="SyncEngine";class VE{constructor(e,t,n){this.query=e,this.targetId=t,this.view=n}}class RE{constructor(e){this.key=e,this.cu=!1}}class kE{constructor(e,t,n,r,o,a){this.localStore=e,this.remoteStore=t,this.eventManager=n,this.sharedClientState=r,this.currentUser=o,this.maxConcurrentLimboResolutions=a,this.lu={},this.hu=new Ft(u=>Tu(u),er),this.Pu=new Map,this.Tu=new Set,this.Iu=new pe(G.comparator),this.Eu=new Map,this.du=new Hi,this.Au={},this.Ru=new Map,this.Vu=nn.lr(),this.onlineState="Unknown",this.mu=void 0}get isPrimaryClient(){return this.mu===!0}}async function CE(s,e,t=!0){const n=cc(s);let r;const o=n.hu.get(e);return o?(n.sharedClientState.addLocalQueryTarget(o.targetId),r=o.view.uu()):r=await ic(n,e,t,!0),r}async function DE(s,e){const t=cc(s);await ic(t,e,!0,!1)}async function ic(s,e,t,n){const r=await Qy(s.localStore,Ye(e)),o=r.targetId,a=s.sharedClientState.addLocalQueryTarget(o,t);let u;return n&&(u=await NE(s,e,o,a==="current",r.resumeToken)),s.isPrimaryClient&&t&&Yu(s.remoteStore,r),u}async function NE(s,e,t,n,r){s.fu=(_,y,S)=>async function(x,N,X,K){let ee=N.view.tu(X);ee.Cs&&(ee=await il(x.localStore,N.query,!1).then(({documents:w})=>N.view.tu(w,ee)));const he=K&&K.targetChanges.get(N.targetId),ke=K&&K.targetMismatches.get(N.targetId)!=null,ye=N.view.applyChanges(ee,x.isPrimaryClient,he,ke);return ml(x,N.targetId,ye.ou),ye.snapshot}(s,_,y,S);const o=await il(s.localStore,e,!0),a=new SE(e,o.$s),u=a.tu(o.documents),h=Yn.createSynthesizedTargetChangeForCurrentChange(t,n&&s.onlineState!=="Offline",r),d=a.applyChanges(u,s.isPrimaryClient,h);ml(s,t,d.ou);const p=new VE(e,t,a);return s.hu.set(e,p),s.Pu.has(t)?s.Pu.get(t).push(e):s.Pu.set(t,[e]),d.snapshot}async function LE(s,e,t){const n=J(s),r=n.hu.get(e),o=n.Pu.get(r.targetId);if(o.length>1)return n.Pu.set(r.targetId,o.filter(a=>!er(a,e))),void n.hu.delete(e);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(r.targetId),n.sharedClientState.isActiveQueryTarget(r.targetId)||await fi(n.localStore,r.targetId,!1).then(()=>{n.sharedClientState.clearQueryState(r.targetId),t&&Ki(n.remoteStore,r.targetId),gi(n,r.targetId)}).catch(ln)):(gi(n,r.targetId),await fi(n.localStore,r.targetId,!0))}async function ME(s,e){const t=J(s),n=t.hu.get(e),r=t.Pu.get(n.targetId);t.isPrimaryClient&&r.length===1&&(t.sharedClientState.removeLocalQueryTarget(n.targetId),Ki(t.remoteStore,n.targetId))}async function OE(s,e,t){const n=HE(s);try{const r=await function(a,u){const h=J(a),d=Ie.now(),p=u.reduce((S,M)=>S.add(M.key),re());let _,y;return h.persistence.runTransaction("Locally write mutations","readwrite",S=>{let M=at(),x=re();return h.Bs.getEntries(S,p).next(N=>{M=N,M.forEach((X,K)=>{K.isValidDocument()||(x=x.add(X))})}).next(()=>h.localDocuments.getOverlayedDocuments(S,M)).next(N=>{_=N;const X=[];for(const K of u){const ee=Qv(K,_.get(K.key).overlayedDocument);ee!=null&&X.push(new St(K.key,ee,pu(ee.value.mapValue),Je.exists(!0)))}return h.mutationQueue.addMutationBatch(S,d,X,u)}).next(N=>{y=N;const X=N.applyToLocalDocumentSet(_,x);return h.documentOverlayCache.saveOverlays(S,N.batchId,X)})}).then(()=>({batchId:y.batchId,changes:Au(_)}))}(n.localStore,e);n.sharedClientState.addPendingMutation(r.batchId),function(a,u,h){let d=a.Au[a.currentUser.toKey()];d||(d=new pe(te)),d=d.insert(u,h),a.Au[a.currentUser.toKey()]=d}(n,r.batchId,t),await Zn(n,r.changes),await ar(n.remoteStore)}catch(r){const o=Ji(r,"Failed to persist write");t.reject(o)}}async function oc(s,e){const t=J(s);try{const n=await Gy(t.localStore,e);e.targetChanges.forEach((r,o)=>{const a=t.Eu.get(o);a&&(ce(r.addedDocuments.size+r.modifiedDocuments.size+r.removedDocuments.size<=1,22616),r.addedDocuments.size>0?a.cu=!0:r.modifiedDocuments.size>0?ce(a.cu,14607):r.removedDocuments.size>0&&(ce(a.cu,42227),a.cu=!1))}),await Zn(t,n,e)}catch(n){await ln(n)}}function pl(s,e,t){const n=J(s);if(n.isPrimaryClient&&t===0||!n.isPrimaryClient&&t===1){const r=[];n.hu.forEach((o,a)=>{const u=a.view.Fa(e);u.snapshot&&r.push(u.snapshot)}),function(a,u){const h=J(a);h.onlineState=u;let d=!1;h.queries.forEach((p,_)=>{for(const y of _.Sa)y.Fa(u)&&(d=!0)}),d&&Zi(h)}(n.eventManager,e),r.length&&n.lu.Y_(r),n.onlineState=e,n.isPrimaryClient&&n.sharedClientState.setOnlineState(e)}}async function $E(s,e,t){const n=J(s);n.sharedClientState.updateQueryState(e,"rejected",t);const r=n.Eu.get(e),o=r&&r.key;if(o){let a=new pe(G.comparator);a=a.insert(o,$e.newNoDocument(o,Y.min()));const u=re().add(o),h=new rr(Y.min(),new Map,new pe(te),a,u);await oc(n,h),n.Iu=n.Iu.remove(o),n.Eu.delete(e),to(n)}else await fi(n.localStore,e,!1).then(()=>gi(n,e,t)).catch(ln)}async function xE(s,e){const t=J(s),n=e.batch.batchId;try{const r=await zy(t.localStore,e);lc(t,n,null),ac(t,n),t.sharedClientState.updateMutationState(n,"acknowledged"),await Zn(t,r)}catch(r){await ln(r)}}async function FE(s,e,t){const n=J(s);try{const r=await function(a,u){const h=J(a);return h.persistence.runTransaction("Reject batch","readwrite-primary",d=>{let p;return h.mutationQueue.lookupMutationBatch(d,u).next(_=>(ce(_!==null,37113),p=_.keys(),h.mutationQueue.removeMutationBatch(d,_))).next(()=>h.mutationQueue.performConsistencyCheck(d)).next(()=>h.documentOverlayCache.removeOverlaysForBatchId(d,p,u)).next(()=>h.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,p)).next(()=>h.localDocuments.getDocuments(d,p))})}(n.localStore,e);lc(n,e,t),ac(n,e),n.sharedClientState.updateMutationState(e,"rejected",t),await Zn(n,r)}catch(r){await ln(r)}}function ac(s,e){(s.Ru.get(e)||[]).forEach(t=>{t.resolve()}),s.Ru.delete(e)}function lc(s,e,t){const n=J(s);let r=n.Au[n.currentUser.toKey()];if(r){const o=r.get(e);o&&(t?o.reject(t):o.resolve(),r=r.remove(e)),n.Au[n.currentUser.toKey()]=r}}function gi(s,e,t=null){s.sharedClientState.removeLocalQueryTarget(e);for(const n of s.Pu.get(e))s.hu.delete(n),t&&s.lu.gu(n,t);s.Pu.delete(e),s.isPrimaryClient&&s.du.Hr(e).forEach(n=>{s.du.containsKey(n)||uc(s,n)})}function uc(s,e){s.Tu.delete(e.path.canonicalString());const t=s.Iu.get(e);t!==null&&(Ki(s.remoteStore,t),s.Iu=s.Iu.remove(e),s.Eu.delete(t),to(s))}function ml(s,e,t){for(const n of t)n instanceof sc?(s.du.addReference(n.key,e),BE(s,n)):n instanceof rc?(F(eo,"Document no longer in limbo: "+n.key),s.du.removeReference(n.key,e),s.du.containsKey(n.key)||uc(s,n.key)):Q(19791,{pu:n})}function BE(s,e){const t=e.key,n=t.path.canonicalString();s.Iu.get(t)||s.Tu.has(n)||(F(eo,"New document in limbo: "+t),s.Tu.add(n),to(s))}function to(s){for(;s.Tu.size>0&&s.Iu.size<s.maxConcurrentLimboResolutions;){const e=s.Tu.values().next().value;s.Tu.delete(e);const t=new G(ge.fromString(e)),n=s.Vu.next();s.Eu.set(n,new RE(t)),s.Iu=s.Iu.insert(t,n),Yu(s.remoteStore,new ft(Ye(xi(t.path)),n,"TargetPurposeLimboResolution",Xs.le))}}async function Zn(s,e,t){const n=J(s),r=[],o=[],a=[];n.hu.isEmpty()||(n.hu.forEach((u,h)=>{a.push(n.fu(h,e,t).then(d=>{var p;if((d||t)&&n.isPrimaryClient){const _=d?!d.fromCache:(p=t==null?void 0:t.targetChanges.get(h.targetId))===null||p===void 0?void 0:p.current;n.sharedClientState.updateQueryState(h.targetId,_?"current":"not-current")}if(d){r.push(d);const _=zi.Rs(h.targetId,d);o.push(_)}}))}),await Promise.all(a),n.lu.Y_(r),await async function(h,d){const p=J(h);try{await p.persistence.runTransaction("notifyLocalViewChanges","readwrite",_=>D.forEach(d,y=>D.forEach(y.ds,S=>p.persistence.referenceDelegate.addReference(_,y.targetId,S)).next(()=>D.forEach(y.As,S=>p.persistence.referenceDelegate.removeReference(_,y.targetId,S)))))}catch(_){if(!un(_))throw _;F(Gi,"Failed to update sequence numbers: "+_)}for(const _ of d){const y=_.targetId;if(!_.fromCache){const S=p.xs.get(y),M=S.snapshotVersion,x=S.withLastLimboFreeSnapshotVersion(M);p.xs=p.xs.insert(y,x)}}}(n.localStore,o))}async function UE(s,e){const t=J(s);if(!t.currentUser.isEqual(e)){F(eo,"User change. New user:",e.toKey());const n=await Ku(t.localStore,e);t.currentUser=e,function(o,a){o.Ru.forEach(u=>{u.forEach(h=>{h.reject(new z(O.CANCELLED,a))})}),o.Ru.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,n.removedBatchIds,n.addedBatchIds),await Zn(t,n.ks)}}function jE(s,e){const t=J(s),n=t.Eu.get(e);if(n&&n.cu)return re().add(n.key);{let r=re();const o=t.Pu.get(e);if(!o)return r;for(const a of o){const u=t.hu.get(a);r=r.unionWith(u.view.eu)}return r}}function cc(s){const e=J(s);return e.remoteStore.remoteSyncer.applyRemoteEvent=oc.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=jE.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=$E.bind(null,e),e.lu.Y_=AE.bind(null,e.eventManager),e.lu.gu=bE.bind(null,e.eventManager),e}function HE(s){const e=J(s);return e.remoteStore.remoteSyncer.applySuccessfulWrite=xE.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=FE.bind(null,e),e}class qs{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=ir(e.databaseInfo.databaseId),this.sharedClientState=this.bu(e),this.persistence=this.Su(e),await this.persistence.start(),this.localStore=this.Du(e),this.gcScheduler=this.vu(e,this.localStore),this.indexBackfillerScheduler=this.Cu(e,this.localStore)}vu(e,t){return null}Cu(e,t){return null}Du(e){return qy(this.persistence,new Uy,e.initialUser,this.serializer)}Su(e){return new Gu(qi.fi,this.serializer)}bu(e){return new Yy}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}qs.provider={build:()=>new qs};class qE extends qs{constructor(e){super(),this.cacheSizeBytes=e}vu(e,t){ce(this.persistence.referenceDelegate instanceof js,46915);const n=this.persistence.referenceDelegate.garbageCollector;return new Py(n,e.asyncQueue,t)}Su(e){const t=this.cacheSizeBytes!==void 0?Be.withCacheSize(this.cacheSizeBytes):Be.DEFAULT;return new Gu(n=>js.fi(n,t),this.serializer)}}class _i{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=n=>pl(this.syncEngine,n,1),this.remoteStore.remoteSyncer.handleCredentialChange=UE.bind(null,this.syncEngine),await yE(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new TE}()}createDatastore(e){const t=ir(e.databaseInfo.databaseId),n=function(o){return new nE(o)}(e.databaseInfo);return function(o,a,u,h){return new oE(o,a,u,h)}(e.authCredentials,e.appCheckCredentials,n,t)}createRemoteStore(e){return function(n,r,o,a,u){return new lE(n,r,o,a,u)}(this.localStore,this.datastore,e.asyncQueue,t=>pl(this.syncEngine,t,0),function(){return ll.C()?new ll:new Jy}())}createSyncEngine(e,t){return function(r,o,a,u,h,d,p){const _=new kE(r,o,a,u,h,d);return p&&(_.mu=!0),_}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(r){const o=J(r);F($t,"RemoteStore shutting down."),o.da.add(5),await Jn(o),o.Ra.shutdown(),o.Va.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}_i.provider={build:()=>new _i};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zE{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Mu(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Mu(this.observer.error,e):ot("Uncaught Error in snapshot listener:",e.toString()))}xu(){this.muted=!0}Mu(e,t){setTimeout(()=>{this.muted||e(t)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const At="FirestoreClient";class GE{constructor(e,t,n,r,o){this.authCredentials=e,this.appCheckCredentials=t,this.asyncQueue=n,this.databaseInfo=r,this.user=Oe.UNAUTHENTICATED,this.clientId=ru.newId(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this._uninitializedComponentsProvider=o,this.authCredentials.start(n,async a=>{F(At,"Received user=",a.uid),await this.authCredentialListener(a),this.user=a}),this.appCheckCredentials.start(n,a=>(F(At,"Received new app check token=",a),this.appCheckCredentialListener(a,this.user)))}get configuration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}terminate(){this.asyncQueue.enterRestrictedMode();const e=new vt;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(t){const n=Ji(t,"Failed to shutdown persistence");e.reject(n)}}),e.promise}}async function zr(s,e){s.asyncQueue.verifyOperationInProgress(),F(At,"Initializing OfflineComponentProvider");const t=s.configuration;await e.initialize(t);let n=t.initialUser;s.setCredentialChangeListener(async r=>{n.isEqual(r)||(await Ku(e.localStore,r),n=r)}),e.persistence.setDatabaseDeletedListener(()=>s.terminate()),s._offlineComponents=e}async function gl(s,e){s.asyncQueue.verifyOperationInProgress();const t=await KE(s);F(At,"Initializing OnlineComponentProvider"),await e.initialize(t,s.configuration),s.setCredentialChangeListener(n=>cl(e.remoteStore,n)),s.setAppCheckTokenChangeListener((n,r)=>cl(e.remoteStore,r)),s._onlineComponents=e}async function KE(s){if(!s._offlineComponents)if(s._uninitializedComponentsProvider){F(At,"Using user provided OfflineComponentProvider");try{await zr(s,s._uninitializedComponentsProvider._offline)}catch(e){const t=e;if(!function(r){return r.name==="FirebaseError"?r.code===O.FAILED_PRECONDITION||r.code===O.UNIMPLEMENTED:!(typeof DOMException<"u"&&r instanceof DOMException)||r.code===22||r.code===20||r.code===11}(t))throw t;Jt("Error using user provided cache. Falling back to memory cache: "+t),await zr(s,new qs)}}else F(At,"Using default OfflineComponentProvider"),await zr(s,new qE(void 0));return s._offlineComponents}async function hc(s){return s._onlineComponents||(s._uninitializedComponentsProvider?(F(At,"Using user provided OnlineComponentProvider"),await gl(s,s._uninitializedComponentsProvider._online)):(F(At,"Using default OnlineComponentProvider"),await gl(s,new _i))),s._onlineComponents}function WE(s){return hc(s).then(e=>e.syncEngine)}async function QE(s){const e=await hc(s),t=e.eventManager;return t.onListen=CE.bind(null,e.syncEngine),t.onUnlisten=LE.bind(null,e.syncEngine),t.onFirstRemoteStoreListen=DE.bind(null,e.syncEngine),t.onLastRemoteStoreUnlisten=ME.bind(null,e.syncEngine),t}function XE(s,e,t={}){const n=new vt;return s.asyncQueue.enqueueAndForget(async()=>function(o,a,u,h,d){const p=new zE({next:y=>{p.xu(),a.enqueueAndForget(()=>wE(o,_));const S=y.docs.has(u);!S&&y.fromCache?d.reject(new z(O.UNAVAILABLE,"Failed to get document because the client is offline.")):S&&y.fromCache&&h&&h.source==="server"?d.reject(new z(O.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):d.resolve(y)},error:y=>d.reject(y)}),_=new PE(xi(u.path),p,{includeMetadataChanges:!0,Qa:!0});return IE(o,_)}(await QE(s),s.asyncQueue,e,t,n)),n.promise}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+s.stack),e}class lr extends so{constructor(e,t,n,r){super(e,t,n,r),this.type="firestore",this._queue=new Il,this._persistenceKey=(r==null?void 0:r.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new Il(e),this._firestoreClient=void 0,await e}}}function tT(s,e){const t=typeof s=="object"?s:H_(),n=typeof s=="string"?s:Os,r=x_(t,"firestore").getImmediate({identifier:n});if(!r._initialized){const o=Sg("firestore");o&&ZE(r,...o)}return r}function pc(s){if(s._terminated)throw new z(O.FAILED_PRECONDITION,"The client has already been terminated.");return s._firestoreClient||nT(s),s._firestoreClient}function nT(s){var e,t,n;const r=s._freezeSettings(),o=function(u,h,d,p){return new yv(u,h,d,p.host,p.ssl,p.experimentalForceLongPolling,p.experimentalAutoDetectLongPolling,dc(p.experimentalLongPollingOptions),p.useFetchStreams,p.isUsingEmulator)}(s._databaseId,((e=s._app)===null||e===void 0?void 0:e.options.appId)||"",s._persistenceKey,r);s._componentsProvider||!((t=r.localCache)===null||t===void 0)&&t._offlineComponentProvider&&(!((n=r.localCache)===null||n===void 0)&&n._onlineComponentProvider)&&(s._componentsProvider={_offline:r.localCache._offlineComponentProvider,_online:r.localCache._onlineComponentProvider}),s._firestoreClient=new GE(s._authCredentials,s._appCheckCredentials,s._queue,o,s._componentsProvider&&function(u){const h=u==null?void 0:u._online.build();return{_offline:u==null?void 0:u._offline.build(h),_online:h}}(s._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dT(s,e,t){let n;return n=s?s.toFirestore(e):e,n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fT{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class wc extends Tc{constructor(e,t,n,r,o,a){super(e,t,n,r,a),this._firestore=e,this._firestoreImpl=e,this.metadata=o}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new pT(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const n=this._document.data.field(Ic("DocumentSnapshot.get",e));if(n!==null)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}}class pT extends wc{data(e={}){return super.data(e)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Al(s){s=xt(s,qe);const e=xt(s.firestore,lr);return XE(pc(e),s._key).then(t=>vT(e,s,t))}class mT extends hT{constructor(e){super(),this.firestore=e}convertBytes(e){return new rn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new qe(this.firestore,null,t)}}function gT(s,e,t){s=xt(s,qe);const n=xt(s.firestore,lr),r=dT(s.converter,e);return Ac(n,[oT(_c(n),"setDoc",s._key,r,s.converter!==null,t).toMutation(s._key,Je.none())])}function _T(s,e,t,...n){s=xt(s,qe);const r=xt(s.firestore,lr),o=_c(r);let a;return a=typeof(e=Mt(e))=="string"||e instanceof ur?lT(o,"updateDoc",s._key,e,t,n):aT(o,"updateDoc",s._key,e),Ac(r,[a.toMutation(s._key,Je.exists(!0))])}function Ac(s,e){return function(n,r){const o=new vt;return n.asyncQueue.enqueueAndForget(async()=>OE(await WE(n),r,o)),o.promise}(pc(s),e)}function vT(s,e,t){const n=t.docs.get(e._key),r=new mT(s);return new wc(s,r,e._key,n,new fT(t.hasPendingWrites,t.fromCache),e.converter)}function yT(s){return new lo("increment",s)}(function(e,t=!0){(function(r){an=r})(j_),Ls(new $n("firestore",(n,{instanceIdentifier:r,options:o})=>{const a=n.getProvider("app").getImmediate(),u=new lr(new nv(n.getProvider("auth-internal")),new iv(a,n.getProvider("app-check-internal")),function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new z(O.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Un(d.options.projectId,p)}(a,r),a);return o=Object.assign({useFetchStreams:t},o),u._setSettings(o),u},"PUBLIC").setMultipleInstances(!0)),Xt(Ra,ka,e),Xt(Ra,ka,"esm2017")})();var ET="firebase",TT="11.9.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Xt(ET,TT,"app");const IT={apiKey:"AIzaSyA7DEXo4vLvGinpIrOhhCXtoawV0l4zBBc",authDomain:"holybear-goodbad.firebaseapp.com",projectId:"holybear-goodbad",storageBucket:"holybear-goodbad.appspot.com",messagingSenderId:"227880753618",appId:"1:227880753618:web:280ac7b02894ea857cd00b",measurementId:"G-1FQ8WE5HHE"},wT=Gl(IT),AT=tT(wT);async function bl(s,e={}){try{const t=eT(AT,"views",s),n=await Al(t);return e.onlyRead?n.exists()&&n.data().count||0:n.exists()?(await _T(t,{count:yT(1)}),(await Al(t)).data().count||0):(await gT(t,{count:1}),1)}catch(t){throw console.error("[view-count.js] Firestore error:",t),t}}const bT={class:"view-count"},PT={__name:"ViewCounter",props:{slug:String},setup(s){const e=s,t=ne(null);function n(a){return JSON.parse(localStorage.getItem("viewedSlugs")||"[]").includes(a)}function r(a){const u=JSON.parse(localStorage.getItem("viewedSlugs")||"[]");u.includes(a)||(u.push(a),localStorage.setItem("viewedSlugs",JSON.stringify(u)))}async function o(a){if(a)try{n(a)?t.value=await bl(a,{onlyRead:!0}):(t.value=await bl(a),r(a))}catch(u){t.value="錯誤",console.error("[ViewCounter] 讀取失敗:",u)}else t.value="無slug",console.warn("[ViewCounter] slug 為空")}return Ke(()=>{o(e.slug)}),ze(()=>e.slug,(a,u)=>{a&&a!==u&&o(a)}),(a,u)=>(T(),R("span",bT,[u[0]||(u[0]=k("img",{src:vh,alt:"人氣",class:"fire-icon",title:"人氣"},null,-1)),_e(" "+Z(t.value===null?"載入中...":t.value),1)]))}},ST=q(PT,[["__scopeId","data-v-743f918c"]]),VT={key:0,class:"blog-post-header-injected"},RT={class:"blog-post-title"},kT={key:0,class:"blog-post-meta-row"},CT={class:"blog-post-date-in-content"},DT={style:{float:"right"}},NT={__name:"MyCustomLayout",setup(s){const{frontmatter:e,page:t}=Gs(),n=W(()=>t.value&&(t.value.path==="/"||t.value.path==="/index.html")),r=W(()=>e.value?e.value.title||"無標題文章":"frontmatter.value is UNDEFINED"),o=W(()=>{var u,h,d;return((u=e.value)==null?void 0:u.slug)||((h=t.value)==null?void 0:h.path)||((d=e.value)==null?void 0:d.title)||"unknown"}),a=W(()=>{var u;if((u=e.value)!=null&&u.date){const h=new Date(e.value.date),d=new Date(h.toLocaleString("en-US",{timeZone:"Asia/Taipei"})),p=d.getFullYear(),_=String(d.getMonth()+1).padStart(2,"0"),y=String(d.getDate()).padStart(2,"0"),S=String(d.getHours()).padStart(2,"0"),M=String(d.getMinutes()).padStart(2,"0");return`${p}-${_}-${y} ${S}:${M}`}return""});return(u,h)=>{const d=bt("ClientOnly");return T(),H(b(tg).Layout,null,{"doc-before":L(()=>[n.value?B("",!0):(T(),R("div",VT,[k("h1",RT,Z(r.value),1),b(e).category&&b(e).category.length||b(e).tag&&b(e).tag.length?(T(),R("div",kT,[(T(!0),R(le,null,Ve(b(e).category,p=>(T(),R("span",{key:"cat-"+p,class:"category"},Z(p),1))),128)),(T(!0),R(le,null,Ve(b(e).tag,p=>(T(),R("span",{key:"tag-"+p,class:"tag"},Z(p),1))),128))])):B("",!0),k("p",CT,[b(e).author?(T(),R(le,{key:0},[_e("作者："+Z(b(e).author),1)],64)):B("",!0),b(e).author&&a.value?(T(),R(le,{key:1},[_e("｜")],64)):B("",!0),a.value?(T(),R(le,{key:2},[_e(Z(a.value),1)],64)):B("",!0),k("span",DT,[U(d,null,{default:L(()=>[U(ST,{slug:o.value},null,8,["slug"])]),_:1})])]),h[0]||(h[0]=k("div",{class:"blog-post-date-divider"},null,-1))]))]),"doc-after":L(()=>[U(d,null,{default:L(()=>[U(gg),U(ig)]),_:1})]),_:1})}}},LT=q(NT,[["__scopeId","data-v-0eb83b7b"]]),$T={Layout:LT};export{$T as R};
